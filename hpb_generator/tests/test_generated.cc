...
using ::protos_generator::test::hpb::ChildModel1;
using ::protos_generator::test::hpb::container_ext;
using ::protos_generator::test::hpb::ContainerExtension;
using ::protos_generator::test::hpb::other_ext;
using ::protos_generator::test::hpb::RED;
using ::protos_generator::test::hpb::TestEnum;
using ::protos_generator::test::hpb::TestModel;
using ::protos_generator::test::hpb::TestModel_Category;
using ::protos_generator::test::hpb::TestModel_Category_IMAGES;
using ::protos_generator::test::hpb::TestModel_Category_NEWS;
using ::protos_generator::test::hpb::TestModel_Category_VIDEO;
using ::protos_generator::test::hpb::theme;
using ::protos_generator::test::hpb::ThemeExtension;
