...
extern const upb_MiniTableEnum* google__protobuf__FeatureSet__DefaultSymbolVisibility_enum_init(void);
...
typedef enum {
  google_protobuf_FeatureSet_DEFAULT_SYMBOL_VISIBILITY_UNKNOWN = 0,
  google_protobuf_FeatureSet_EXPORT_ALL = 1,
  google_protobuf_FeatureSet_EXPORT_TOP_LEVEL = 2,
  google_protobuf_FeatureSet_LOCAL_ALL = 3,
  google_protobuf_FeatureSet_STRICT_VISIBILITY = 4
} google_protobuf_FeatureSet_DefaultSymbolVisibility;
