...
const upb_MiniTable* google__protobuf__FeatureSet_msg_init() {
  ...
  upb_MiniTable_SetSubEnum(mini_table, (upb_MiniTableField*)upb_MiniTable_FindFieldByNumber(mini_table, 8), google__protobuf__FeatureSet__DefaultSymbolVisibility_enum_init());
  return mini_table;
}
...
const upb_MiniTableEnum* google__protobuf__FeatureSet__DefaultSymbolVisibility_enum_init() {
  static const upb_MiniTableEnum* mini_table = NULL;
