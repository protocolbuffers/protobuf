...
static upb_ArenaRoot _upb_Arena_FindRoot(upb_Arena* a) {
  upb_ArenaInternal* ai = a->internal;
...
static void _upb_Arena_AddBlock(upb_Arena* a, upb_ArenaInternal* ai, void* ptr,
                                size_t size) {
...
static bool _upb_Arena_AllocBlock(upb_Arena* a, size_t size) {
  ...
  _upb_Arena_AddBlock(a, ai, block, block_size);
...
static upb_Arena* _upb_Arena_InitSlow(upb_alloc* alloc) {
  ...
  a->head.internal = &a->body;

  _upb_Arena_AddBlock(&a->head, &a->body, mem, n);
...
bool upb_Arena_Fuse(upb_Arena* a1, upb_Arena* a2) {
  ...
  if (_upb_ArenaInternal_HasInitialBlock(a1->internal) ||
      _upb_ArenaInternal_HasInitialBlock(a2->internal)) {
    return false;
  }
...
bool upb_Arena_IncRefFor(upb_Arena* arena, const void* owner) {
  upb_ArenaRoot r;
  if (_upb_ArenaInternal_HasInitialBlock(arena->internal)) return false;
