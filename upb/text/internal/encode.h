...
void _upb_FieldDebugString(txtenc* e, upb_MessageValue val,
                           const struct upb_MiniTableField* f,
                           const struct upb_MiniTable* mt, const char* label,
                           const struct upb_MiniTableExtension* ext);

void _upb_ArrayDebugString(txtenc* e, const upb_Array* arr,
                           const struct upb_MiniTableField* f,
                           const struct upb_MiniTable* mt,
                           const struct upb_MiniTableExtension* ext);

void _upb_MessageDebugString(txtenc* e, const upb_Message* msg,
                             const struct upb_MiniTable* mt);
