...
load("//third_party/upb/bazel/private:upb_proto_library_internal/aspect.bzl", "upb_proto_aspect_impl")
load("//third_party/upb/bazel/private:upb_proto_library_internal/cc_library_func.bzl", "upb_use_cpp_toolchain")
load("//third_party/upb/bazel/private:upb_proto_library_internal/rule.bzl", "upb_proto_rule_impl")
