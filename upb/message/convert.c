...
const upb_Message* upb_Message_Convert(const upb_Message* src,
  ...
  if (dst) {
    ...
    // Instead, we compare the serialized/decoded round-trip of the original
    ...
    // Round-trip 1: serialize/decode original message `src`
    ...
    // Round-trip 2: serialize/decode converted message `dst`
