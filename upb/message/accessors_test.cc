...
TEST(GeneratedCode, HazzersProto2) {
  ...
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_bool_field));
  protobuf_test_messages_proto2_TestAllTypesProto2_set_optional_bool(msg, true);
  EXPECT_EQ(true, upb_Message_HasField((upb_Message*)msg, optional_bool_field));
  upb_Message_ClearField((upb_Message*)msg, optional_bool_field);
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_bool_field));
  EXPECT_EQ(
      false,
  ...
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_string_field));
  ...
  EXPECT_EQ(
      ...
      protobuf_test_messages_proto2_TestAllTypesProto2_optional_string(msg)
          .size);
  upb_Message_ClearField((upb_Message*)msg, optional_string_field);
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_string_field));
  EXPECT_EQ(
  ...
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_message_field));
  protobuf_test_messages_proto2_TestAllTypesProto2_mutable_optional_nested_message(
      msg, arena);
  EXPECT_EQ(true,
            upb_Message_HasField((upb_Message*)msg, optional_message_field));
  upb_Message_ClearField((upb_Message*)msg, optional_message_field);
  EXPECT_EQ(false,
            upb_Message_HasField((upb_Message*)msg, optional_message_field));
  EXPECT_EQ(
      true,
  ...
  EXPECT_EQ(false, upb_Message_HasField((upb_Message*)msg,
  ...
  EXPECT_EQ(true, upb_Message_HasField((upb_Message*)msg,
                                       optional_oneof_uint32_field));
  EXPECT_EQ(false, upb_Message_HasField((upb_Message*)msg,
                                        optional_oneof_string_field));
  ...
  EXPECT_EQ(true, upb_Message_HasField((upb_Message*)msg,
                                       optional_oneof_string_field));
  upb_Message_ClearField((upb_Message*)msg, optional_oneof_uint32_field);
  EXPECT_EQ(false, upb_Message_HasField((upb_Message*)msg,
                                        optional_oneof_uint32_field));
  EXPECT_EQ(true, upb_Message_HasField((upb_Message*)msg,
                                       optional_oneof_string_field));
  upb_Message_ClearField((upb_Message*)msg, optional_oneof_string_field);
  EXPECT_EQ(false, upb_Message_HasField((upb_Message*)msg,
                                        optional_oneof_uint32_field));
  EXPECT_EQ(false, upb_Message_HasField((upb_Message*)msg,
                                        optional_oneof_string_field));
...
TEST(GeneratedCode, ScalarsProto2) {
  ...
  EXPECT_EQ(0,
            upb_Message_GetInt32((upb_Message*)msg, optional_int32_field, 0));
  upb_Message_SetInt32((upb_Message*)msg, optional_int32_field, kTestInt32,
                       nullptr);
  EXPECT_EQ(true,
            upb_Message_HasField((upb_Message*)msg, optional_int32_field));
  ...
  EXPECT_EQ(0,
            upb_Message_GetUInt32((upb_Message*)msg, optional_uint32_field, 0));
  upb_Message_SetUInt32((upb_Message*)msg, optional_uint32_field, kTestUInt32,
                        nullptr);
...
TEST(GeneratedCode, ScalarProto3) {
  ...
  upb_Message_SetInt64((upb_Message*)msg, optional_int64_field, -1, nullptr);
  EXPECT_EQ(
      -1, protobuf_test_messages_proto3_TestAllTypesProto3_optional_int64(msg));
  EXPECT_EQ(-1,
            upb_Message_GetInt64((upb_Message*)msg, optional_int64_field, 0));

  EXPECT_EQ(
      0, protobuf_test_messages_proto3_TestAllTypesProto3_optional_uint64(msg));
  upb_Message_SetUInt64((upb_Message*)msg, optional_uint64_field, kTestUInt64,
                        nullptr);
  EXPECT_EQ(
      kTestUInt64,
      protobuf_test_messages_proto3_TestAllTypesProto3_optional_uint64(msg));
  EXPECT_EQ(kTestUInt64,
            upb_Message_GetUInt64((upb_Message*)msg, optional_uint64_field, 0));
...
TEST(GeneratedCode, Strings) {
  ...
  upb_StringView value = upb_Message_GetString(
      (upb_Message*)msg, optional_string_field, upb_StringView{nullptr, 0});
  ...
  EXPECT_EQ(
      ...
      protobuf_test_messages_proto2_TestAllTypesProto2_has_optional_string(
          msg));
  upb_Message_SetString((upb_Message*)msg, optional_string_field,
...
TEST(GeneratedCode, SubMessage) {
  ...
  const upb_Message* test_message = upb_Message_GetMessage(
      (upb_Message*)msg, optional_message_field, nullptr);
  ...
  const upb_Message* sub_message = upb_Message_GetMessage(
      (upb_Message*)msg, optional_message_field, nullptr);
  ...
  upb_Message* new_nested_message = (upb_Message*)
      protobuf_test_messages_proto2_TestAllTypesProto2_NestedMessage_new(arena);
  upb_Message_SetInt32((upb_Message*)new_nested_message, nested_message_a_field,
                       123, nullptr);
  ...
  EXPECT_EQ(true,
            upb_Message_HasField((upb_Message*)msg, optional_message_field));
  EXPECT_EQ(123, upb_Message_GetInt32((upb_Message*)mutable_message,
                                      nested_message_a_field, 0));
...
TEST(GeneratedCode, RepeatedScalar) {
  ...
  EXPECT_EQ(nullptr,
            upb_Message_GetArray((upb_Message*)msg, repeated_int32_field));
  ...
  upb_Array* mutable_array =
      upb_Message_GetMutableArray((upb_Message*)msg, repeated_int32_field);
