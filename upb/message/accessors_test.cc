...
TEST(GeneratedCode, HazzersProto2) {
  ...
  upb_Message_ClearNormalField(UPB_UPCAST(msg), optional_bool_field);
  EXPECT_EQ(false, upb_Message_HasField(UPB_UPCAST(msg), optional_bool_field));
  EXPECT_EQ(
      false,
  ...
  EXPECT_EQ(
      ...
      protobuf_test_messages_proto2_TestAllTypesProto2_optional_string(msg)
          .size);
  upb_Message_ClearNormalField(UPB_UPCAST(msg), optional_string_field);
  EXPECT_EQ(false,
            upb_Message_HasField(UPB_UPCAST(msg), optional_string_field));
  EXPECT_EQ(
  ...
  EXPECT_EQ(true,
            upb_Message_HasField(UPB_UPCAST(msg), optional_message_field));
  upb_Message_ClearNormalField(UPB_UPCAST(msg), optional_message_field);
  EXPECT_EQ(false,
            upb_Message_HasField(UPB_UPCAST(msg), optional_message_field));
  EXPECT_EQ(
      true,
  ...
  EXPECT_EQ(true,
            upb_Message_HasField(UPB_UPCAST(msg), optional_oneof_string_field));
  upb_Message_ClearNormalField(UPB_UPCAST(msg), optional_oneof_uint32_field);
  EXPECT_EQ(false,
            upb_Message_HasField(UPB_UPCAST(msg), optional_oneof_uint32_field));
  EXPECT_EQ(true,
            upb_Message_HasField(UPB_UPCAST(msg), optional_oneof_string_field));
  upb_Message_ClearNormalField(UPB_UPCAST(msg), optional_oneof_string_field);
  EXPECT_EQ(false,
            upb_Message_HasField(UPB_UPCAST(msg), optional_oneof_uint32_field));
  EXPECT_EQ(false,
            upb_Message_HasField(UPB_UPCAST(msg), optional_oneof_string_field));
