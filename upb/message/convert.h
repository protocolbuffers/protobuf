...
// registry allows it).
//
// Returns a new message on success, or NULL on failure. On errors, the caller
// can try to fallback to serializing the source message and then decoding it
// using the destination `upb_MiniTable`.
