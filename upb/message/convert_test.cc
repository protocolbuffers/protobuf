...
TEST_P(ConvertTest, OneofDemotion) {
  ...
  const upb_Message* dst = UPB_PRIVATE(_upb_Message_Convert)(
      UPB_UPCAST(msg), src_mt, empty_mt, nullptr, GetParam(), arena.ptr());
  EXPECT_NE(dst, nullptr);
  ...
  const upb_Message* dst2_msg = UPB_PRIVATE(_upb_Message_Convert)(
      dst, empty_mt, src_mt, nullptr, GetParam(), arena.ptr());
