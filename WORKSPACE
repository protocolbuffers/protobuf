...
# Override @com_google_protobuf_v22.0 upb repo with v22.0 patch file.
# Override @com_google_protobuf_v22.0 upb repo with v22.0 patch file.
http_archive(
    name = "upb",
    urls = ["https://github.com/protocolbuffers/upb/archive/7af7938239bf027022e90438d4c6dbcdce007fb9.zip"],
    strip_prefix = "upb-7af7938239bf027022e90438d4c6dbcdce007fb9",
    sha256 = "99b44fe57266c897ca1d2af96e4ced314344d40f34f7f99d458ddcc76b56f827",
    patches = ["@com_google_protobuf_v22.0//build_defs:upb.patch"],
)

# Needed as a dependency of @com_google_protobuf_v22.0
