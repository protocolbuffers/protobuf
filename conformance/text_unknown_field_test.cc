...
TEST_P(TextUnknownFieldTest, ScalarUnknownFields) {
  ...
  EXPECT_THAT(Testee("ScalarUnknownFields_Drop")
              ...
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
                                     EqualsTextProto(""))));
  EXPECT_THAT(Testee("ScalarUnknownFields_Print")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
...
TEST_P(TextUnknownFieldTest, MessageUnknownFields) {
  ...
  const std::string bytes = unknown.SerializeAsString();
  EXPECT_THAT(Testee("MessageUnknownFields_Drop")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText(),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
                                     EqualsTextProto(""))));
  EXPECT_THAT(Testee("MessageUnknownFields_Print")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText({/*print_unknown_fields=*/true}),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
...
TEST_P(TextUnknownFieldTest, GroupUnknownFields) {
  ...
  const std::string bytes = unknown.SerializeAsString();
  EXPECT_THAT(Testee("GroupUnknownFields_Drop")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText(),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
                                     EqualsTextProto(""))));
  EXPECT_THAT(Testee("GroupUnknownFields_Print")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText({/*print_unknown_fields=*/true}),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
...
TEST_P(TextUnknownFieldTest, RepeatedUnknownFields) {
  ...
  const std::string bytes = unknown.SerializeAsString();
  EXPECT_THAT(Testee("RepeatedUnknownFields_Drop")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText(),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
                                     EqualsTextProto(""))));
  EXPECT_THAT(Testee("RepeatedUnknownFields_Print")
                  .ParseBinary(message(), Wire(bytes))
                  .OverrideTestCategory(::conformance::TEXT_FORMAT_TEST)
                  .SerializeText({/*print_unknown_fields=*/true}),
              Yields(ParsedPayloadAs(UnknownToTestAllTypes::descriptor(),
