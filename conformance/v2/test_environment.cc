...
void TestEnvironment::LoadFailureList(absl::string_view filename) {
...
void TestEnvironment::SaveFailureList(absl::string_view filename) const {
...
absl::Status TestEnvironment::ReportSuccess(absl::string_view test_name) {
...
absl::Status TestEnvironment::ReportFailure(absl::string_view test_name,
...
absl::Status TestEnvironment::ReportSkip(absl::string_view test_name) {
  bool unique = InsertUniqueTest(seen_tests_, test_name);
  IncrementIfUnique(unique, skipped_);
  return absl::OkStatus();
}

absl::Status TestEnvironment::Finalize() const {
