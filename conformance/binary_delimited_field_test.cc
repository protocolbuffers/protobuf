...
TEST_F(DelimitedFieldTest, ValidLengthPrefixedField) {
  EXPECT_THAT(
      Testee("ValidLengthPrefixedField")
...
TEST_F(DelimitedFieldTest, ValidMapLengthPrefixed) {
  EXPECT_THAT(
      Testee("ValidMap.LengthPrefixed")
...
TEST_F(DelimitedFieldTest, GroupLike) {
  EXPECT_THAT(
      Testee("ValidDelimitedField.GroupLike")
...
TEST_F(DelimitedFieldTest, NotGroupLike) {
  EXPECT_THAT(
      Testee("ValidDelimitedField.NotGroupLike")
