...
struct ConformanceEnvironmentOptions {
  ...
  // Whether failures in recommended (P3) tests count as failures.  When false,
  // they are tolerated (recorded as such) unless the test is listed in the
  // failure list, in which case it counts as an expected failure just like a
  // P0 test would.  The default matches the conformance_test_runner command
  // line.
...
//
// e.g. "P0.PrematureEofTest.BeforeKnownNonRepeatedValue/Proto3_INT32.
