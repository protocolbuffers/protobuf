...
struct ConformanceEnvironmentOptions {
  ...
  // performance run needs its own failure list (as with the conformance
  ...
  // suite/binary; this in-binary mode mirrors the conformance_test_runner
  // --performance flag.
...
// TODO: b/563657875 - once the merged runner has retired (its users moved to
