...
// The response every Proto3JsonRequest() yields.  Kept out of the macro
// arguments: MSVC's traditional preprocessor mis-scans raw string literals
// containing \" inside macro arguments.
constexpr absl::string_view kProto3JsonResponse =
    R"pb(json_payload: "{\"optionalInt32\":42,\"optionalString\":\"hello\"}")pb";
