...
TEST_P(TextAnyTest, AnyField) {
  ...
  EXPECT_THAT(Testee("AnyField").ParseText(message(), kInput).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyField").ParseText(message(), kInput).SerializeText(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
}
...
TEST_P(TextAnyTest, WithRawBytes) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithRawBytes")
...
TEST_P(TextAnyTest, WithInvalidType) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithInvalidType")
                  .ParseText(message(), kInput)
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextAnyTest, WithCustomTypeUrlPrefix) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithCustomTypeUrlPrefix")
                  .ParseText(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyFieldWithCustomTypeUrlPrefix")
...
TEST_P(TextAnyTest, WithSpecialCharactersInTypeUrlPrefix) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithSpecialCharactersInTypeUrlPrefix")
                  .ParseText(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyFieldWithSpecialCharactersInTypeUrlPrefix")
...
TEST_P(TextAnyTest, WithValidUrlPercentEscapeInTypeUrlPrefix) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithValidUrlPercentEscapeInTypeUrlPrefix")
                  .ParseText(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyFieldWithValidUrlPercentEscapeInTypeUrlPrefix")
...
TEST_P(TextAnyTest, WithInvalidUrlPercentEscapeInTypeUrlPrefix) {
  ...
  EXPECT_THAT(Testee("AnyFieldWithInvalidUrlPercentEscapeInTypeUrlPrefix")
                  .ParseText(message(), kInput)
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextAnyTest, WithWhitespaceInTypeUrl) {
  constexpr absl::string_view kInput =
      ...
      "  }\n"
      "}";
  EXPECT_THAT(Testee("AnyFieldWithWhitespaceInTypeUrl")
                  .ParseText(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyFieldWithWhitespaceInTypeUrl")
...
TEST_P(TextAnyTest, WithCommentsInTypeUrl) {
  constexpr absl::string_view kInput =
      ...
      "  }\n"
      "}";
  EXPECT_THAT(Testee("AnyFieldWithCommentsInTypeUrl")
                  .ParseText(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kInput))));
  EXPECT_THAT(Testee("AnyFieldWithCommentsInTypeUrl")
