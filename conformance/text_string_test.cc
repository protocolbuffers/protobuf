...
TEST_P(TextStringLiteralTest, Concat) {
  ...
  EXPECT_THAT(Testee(kP0, TestName("Concat"))
...
TEST_P(TextStringLiteralTest, BasicEscapes) {
  ...
  EXPECT_THAT(Testee(kP0, TestName("BasicEscapes"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(Testee(kP0, TestName("BasicEscapes"))
...
TEST_P(TextStringLiteralTest, OctalEscapes) {
  ...
  EXPECT_THAT(Testee(kP0, TestName("OctalEscapes"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(Testee(kP0, TestName("OctalEscapes"))
...
TEST_P(TextStringLiteralTest, HexEscapes) {
  ...
  EXPECT_THAT(Testee(kP0, TestName("HexEscapes"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(Testee(kP0, TestName("HexEscapes"))
...
TEST_P(TextStringLiteralTest, ShortUnicodeEscape) {
  ...
  EXPECT_THAT(Testee(TestName("ShortUnicodeEscape"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(Testee(TestName("ShortUnicodeEscape"))
...
TEST_P(TextStringLiteralTest, LongUnicodeEscapes) {
  ...
  EXPECT_THAT(Testee(TestName("LongUnicodeEscapes"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(Testee(TestName("LongUnicodeEscapes"))
...
TEST_P(TextStringLiteralTest, IncludesLF) {
  EXPECT_THAT(Testee(kP0, TestName("IncludesLF"))
...
TEST_P(TextStringLiteralTest, LongUnicodeEscapeTooLarge) {
  EXPECT_THAT(Testee(kP0, TestName("LongUnicodeEscapeTooLarge"))
...
TEST_P(TextStringLiteralTest, ShortUnicodeEscapeSurrogatePair) {
  EXPECT_THAT(Testee(TestName("ShortUnicodeEscapeSurrogatePair"))
                  .ParseText(message(), Input("'\\ud801\\udc37'"))
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextStringLiteralTest, ShortUnicodeEscapeSurrogateFirstOnly) {
  EXPECT_THAT(Testee(TestName("ShortUnicodeEscapeSurrogateFirstOnly"))
                  .ParseText(message(), Input("'\\ud800'"))
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextStringLiteralTest, ShortUnicodeEscapeSurrogateSecondOnly) {
  EXPECT_THAT(Testee(TestName("ShortUnicodeEscapeSurrogateSecondOnly"))
                  .ParseText(message(), Input("'\\udc00'"))
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextStringLiteralTest, LongUnicodeEscapeSurrogateFirstOnly) {
  EXPECT_THAT(Testee(TestName("LongUnicodeEscapeSurrogateFirstOnly"))
...
TEST_P(TextStringLiteralTest, LongUnicodeEscapeSurrogateSecondOnly) {
  EXPECT_THAT(Testee(TestName("LongUnicodeEscapeSurrogateSecondOnly"))
...
TEST_P(TextStringLiteralTest, LongUnicodeEscapeSurrogatePair) {
  EXPECT_THAT(Testee(TestName("LongUnicodeEscapeSurrogatePair"))
...
TEST_P(TextStringLiteralTest, UnicodeEscapeSurrogatePairLongShort) {
  EXPECT_THAT(Testee(TestName("UnicodeEscapeSurrogatePairLongShort"))
...
TEST_P(TextStringLiteralTest, UnicodeEscapeSurrogatePairShortLong) {
  EXPECT_THAT(Testee(TestName("UnicodeEscapeSurrogatePairShortLong"))
...
TEST_P(TextStringFieldTest, BadUtf8Octal) {
  EXPECT_THAT(Testee("StringFieldBadUTF8Octal")
...
TEST_P(TextStringFieldTest, BadUtf8Hex) {
  EXPECT_THAT(Testee("StringFieldBadUTF8Hex")
