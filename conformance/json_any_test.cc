        ...
        optional_any: {
          [$0] {
            optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(Testee("Any").ParseJson(message(), input).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
  EXPECT_THAT(Testee("Any").ParseJson(message(), input).SerializeJson(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
}
          ...
          [type.googleapis.com/google.protobuf.Any] {
            [$0] {
              optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(Testee("AnyNested").ParseJson(message(), input).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
  EXPECT_THAT(Testee("AnyNested").ParseJson(message(), input).SerializeJson(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
}
        ...
        optional_any: {
          [$0] {
            optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(Testee("AnyUnorderedTypeTag")
                  .ParseJson(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
  EXPECT_THAT(
      Testee("AnyUnorderedTypeTag").ParseJson(message(), input).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(expected))));
}
...
TEST_P(JsonAnyTest, AnyWithInt32ValueWrapper) {
  ...
  EXPECT_THAT(Testee("AnyWithInt32ValueWrapper")
...
TEST_P(JsonAnyTest, AnyWithDuration) {
  ...
  EXPECT_THAT(
      Testee("AnyWithDuration").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("AnyWithDuration").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyWithTimestamp) {
  ...
  EXPECT_THAT(
      Testee("AnyWithTimestamp").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("AnyWithTimestamp").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyWithFieldMask) {
  ...
  EXPECT_THAT(
      Testee("AnyWithFieldMask").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("AnyWithFieldMask").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyWithStruct) {
  ...
  EXPECT_THAT(
      Testee("AnyWithStruct").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("AnyWithStruct").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyWithValueForJsonObject) {
  ...
  EXPECT_THAT(Testee("AnyWithValueForJsonObject")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("AnyWithValueForJsonObject")
...
TEST_P(JsonAnyTest, AnyWithValueForInteger) {
  ...
  EXPECT_THAT(Testee("AnyWithValueForInteger")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("AnyWithValueForInteger")
...
TEST_P(JsonAnyTest, AnyWktRepresentationWithEmptyTypeAndValue) {
  EXPECT_THAT(Testee("AnyWktRepresentationWithEmptyTypeAndValue")
                  .ParseJson(message(), R"({
        "optionalAny": {
          "@type": "",
          "value": ""
...
TEST_P(JsonAnyTest, AnyWktRepresentationWithBadType) {
  EXPECT_THAT(Testee("AnyWktRepresentationWithBadType")
                  .ParseJson(message(), R"({
        "optionalAny": {
          "@type": "not_a_url",
          "value": ""
...
TEST_P(JsonAnyTest, AnyWithNoType) {
  ...
  EXPECT_THAT(
      Testee("AnyWithNoType").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("AnyWithNoType").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyNull) {
  ...
  EXPECT_THAT(Testee("AnyNull").ParseJson(message(), kInput).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("AnyNull").ParseJson(message(), kInput).SerializeJson(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyEmpty) {
  ...
  EXPECT_THAT(Testee("AnyEmpty").ParseJson(message(), kInput).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("AnyEmpty").ParseJson(message(), kInput).SerializeJson(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
