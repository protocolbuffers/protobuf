...
class BinaryAndJsonConformanceSuiteImpl {
 ...
 private:
  ...
  // binary->JSON legs of the singular-field tests remain here; see
  // binary_valid_data_scalar_test.cc.
  ...
  // these wrappers (and the alias) go away once their remaining callers
  // migrate.
