...
TEST_P(TextIntegerTest, Int32FieldTooLarge) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_int32: 2147483648").ParseOnly(),
      Yields(IsParseError()));
}

TEST_P(TextIntegerTest, Int32FieldTooSmall) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_int32: -2147483649").ParseOnly(),
      Yields(IsParseError()));
}

TEST_P(TextIntegerTest, Uint32FieldTooLarge) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_uint32: 4294967296").ParseOnly(),
      Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int32FieldTooLargeHex) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_int32: 0x80000000").ParseOnly(),
      Yields(IsParseError()));
}

TEST_P(TextIntegerTest, Int32FieldTooSmallHex) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_int32: -0x80000001").ParseOnly(),
      Yields(IsParseError()));
}

TEST_P(TextIntegerTest, Uint32FieldTooLargeHex) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_uint32: 0x100000000").ParseOnly(),
      Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int32FieldTooLargeOctal) {
  EXPECT_THAT(
      Testee().ParseText(message(), "optional_int32: 020000000000").ParseOnly(),
      Yields(IsParseError()));
}
