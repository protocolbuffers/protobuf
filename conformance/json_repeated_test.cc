...
TEST_P(JsonRepeatedTest, PrimitiveRepeatedField) {
  ...
  EXPECT_THAT(Testee("PrimitiveRepeatedField")
...
TEST_P(JsonRepeatedTest, EnumRepeatedField) {
  ...
  EXPECT_THAT(Testee("EnumRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("EnumRepeatedField").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonRepeatedTest, StringRepeatedField) {
  ...
  EXPECT_THAT(Testee("StringRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("StringRepeatedField")
...
TEST_P(JsonRepeatedTest, BytesRepeatedField) {
  ...
  EXPECT_THAT(Testee("BytesRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      Testee("BytesRepeatedField").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonRepeatedTest, MessageRepeatedField) {
  ...
  EXPECT_THAT(Testee("MessageRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("MessageRepeatedField")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingIntegersGotBool")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingIntegersGotString")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingIntegersGotMessage")
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingStringsGotInt) {
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingStringsGotInt")
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingStringsGotBool) {
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingStringsGotBool")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(Testee("RepeatedFieldWrongElementTypeExpectingStringsGotMessage")
                  .ParseJson(message(),
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingMessagesGotInt) {
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingMessagesGotInt")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(Testee("RepeatedFieldWrongElementTypeExpectingMessagesGotBool")
                  .ParseJson(message(),
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      Testee("RepeatedFieldWrongElementTypeExpectingMessagesGotString")
          .ParseJson(message(), R"({"repeatedNestedMessage": [{"a": 1}, "2"]})")
          .ParseOnly(),
      Yields(IsParseError()));
}
...
TEST_P(JsonRepeatedTest, SingleValueForRepeatedFieldInt32) {
  EXPECT_THAT(Testee("SingleValueForRepeatedFieldInt32")
...
TEST_P(JsonRepeatedTest, SingleValueForRepeatedFieldMessage) {
  EXPECT_THAT(
      Testee("SingleValueForRepeatedFieldMessage")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingComma) {
  EXPECT_THAT(Testee(kP3, "RepeatedFieldTrailingComma")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithSpace) {
  EXPECT_THAT(Testee(kP3, "RepeatedFieldTrailingCommaWithSpace")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithSpaceCommaSpace) {
  EXPECT_THAT(Testee(kP3, "RepeatedFieldTrailingCommaWithSpaceCommaSpace")
                  .ParseJson(message(), "{\"repeatedInt32\": [1, 2, 3, 4 , ]}")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithNewlines) {
  EXPECT_THAT(
      Testee(kP3, "RepeatedFieldTrailingCommaWithNewlines")
          .ParseJson(message(),
                     "{\"repeatedInt32\": [\n  1,\n  2,\n  3,\n  4,\n]}")
          .ParseOnly(),
      Yields(IsParseError()));
