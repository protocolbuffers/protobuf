...
TEST_P(JsonNullTest, AllFieldAcceptNull) {
  ...
  EXPECT_THAT(Testee(kP0, "AllFieldAcceptNull")
...
TEST_P(JsonNullTest, RepeatedFieldPrimitiveElementIsNull) {
  EXPECT_THAT(Testee("RepeatedFieldPrimitiveElementIsNull")
...
TEST_P(JsonNullTest, RepeatedFieldMessageElementIsNull) {
  EXPECT_THAT(
      Testee("RepeatedFieldMessageElementIsNull")
          .ParseJson(message(),
...
TEST_P(JsonNullTest, MapFieldKeyIsNull) {
  EXPECT_THAT(Testee("MapFieldKeyIsNull")
...
TEST_P(JsonNullTest, MapFieldValueIsNull) {
  EXPECT_THAT(Testee("MapFieldValueIsNull")
