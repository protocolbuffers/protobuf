...
TEST_P(ValidDataOneofTest, DefaultValue) {
  EXPECT_THAT(Testee(TestName("ValidDataOneof", "DefaultValue"))
...
TEST_P(ValidDataOneofTest, DefaultValueBinary) {
  EXPECT_THAT(Testee(kP3, TestName("ValidDataOneofBinary", "DefaultValue"))
                  .ParseBinary(message(), DefaultMember())
                  .SerializeBinary(),
...
TEST_P(ValidDataOneofTest, NonDefaultValue) {
  EXPECT_THAT(Testee(TestName("ValidDataOneof", "NonDefaultValue"))
...
TEST_P(ValidDataOneofTest, NonDefaultValueBinary) {
  EXPECT_THAT(Testee(kP3, TestName("ValidDataOneofBinary", "NonDefaultValue"))
                  .ParseBinary(message(), NonDefaultMember())
                  .SerializeBinary(),
...
TEST_P(ValidDataOneofTest, MultipleValuesForSameField) {
  EXPECT_THAT(
      Testee(TestName("ValidDataOneof", "MultipleValuesForSameField"))
...
TEST_P(ValidDataOneofTest, MultipleValuesForDifferentField) {
  EXPECT_THAT(
      Testee(TestName("ValidDataOneof", "MultipleValuesForDifferentField"))
...
TEST_P(ValidDataOneofTest, MultipleValuesForDifferentFieldBinary) {
  EXPECT_THAT(
      Testee(kP3, TestName("ValidDataOneofBinary",
                           "MultipleValuesForDifferentField"))
          .ParseBinary(message(), Wire(OtherMemberValue(), NonDefaultMember()))
          .SerializeBinary(),
      Yields(Payload(NonDefaultMember())));
