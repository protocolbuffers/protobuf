...
TEST_P(PrematureEofTest, BeforeKnownNonRepeatedValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofBeforeKnownNonRepeatedValue"))
...
TEST_P(PrematureEofTest, BeforeKnownRepeatedValue) {
  EXPECT_THAT(Testee(TestName("PrematureEofBeforeKnownRepeatedValue"))
                  .ParseBinary(message(),
...
TEST_P(PrematureEofTest, BeforeUnknownValue) {
  EXPECT_THAT(Testee(TestName("PrematureEofBeforeUnknownValue"))
...
TEST_P(PrematureEofTest, InsideKnownNonRepeatedValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInsideKnownNonRepeatedValue"))
...
TEST_P(PrematureEofTest, InsideKnownRepeatedValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInsideKnownRepeatedValue"))
          .ParseBinary(message(),
...
TEST_P(PrematureEofTest, InsideUnknownValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInsideUnknownValue"))
...
TEST_P(PrematureEofInDelimitedDataTest, ForKnownNonRepeatedValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInDelimitedDataForKnownNonRepeatedValue"))
...
TEST_P(PrematureEofInDelimitedDataTest, ForKnownRepeatedValue) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInDelimitedDataForKnownRepeatedValue"))
...
TEST_P(PrematureEofInDelimitedDataTest, ForUnknownValue) {
  EXPECT_THAT(Testee(TestName("PrematureEofInDelimitedDataForUnknownValue"))
...
TEST_P(PrematureEofInPackedFieldTest, PackedFieldValue) {
  EXPECT_THAT(Testee(TestName("PrematureEofInPackedFieldValue"))
                  .ParseBinary(message(),
                               LengthPrefixedField(
...
TEST_P(PrematureEofInPackedFieldTest, PackedField) {
  EXPECT_THAT(
      Testee(TestName("PrematureEofInPackedField"))
          .ParseBinary(message(), Wire(Tag(FieldNumber(*RepeatedField()),
                                           WireType::kLengthPrefixed),
                                       Varint(1)))
          .ParseOnly(),
...
TEST_P(PrematureEofInSubmessageValueTest, Message) {
  ...
  EXPECT_THAT(
      Testee("PrematureEofInSubmessageValue.MESSAGE")
