...
// ValidDataRepeated.<TYPE>.* and friends are generated from it in this order.
...
// ValidDataTypes() above enumerates FieldDescriptor::Type independently.
TEST(AllFieldTypesExceptGroupTest, IsEveryTypeButGroup) {
  EXPECT_THAT(AllFieldTypesExceptGroup(),
              UnorderedElementsAreArray(ValidDataTypes()));
}
