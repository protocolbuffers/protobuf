...
class MessageSetTest : public ConformanceTest {
 public:
...
TEST_F(MessageSetTest, ValidMessageSetEncoding) {
  EXPECT_THAT(
      Testee(kP0, "ValidMessageSetEncoding")
          .ParseBinary(
...
TEST_F(MessageSetTest, OutOfOrderGroupsEntries) {
  EXPECT_THAT(
      Testee(kP0, "ValidMessageSetEncoding.OutOfOrderGroupsEntries")
...
TEST_F(MessageSetTest, UnknownExtension) {
  ...
  EXPECT_THAT(Testee(kP0, "MessageSetEncoding.UnknownExtension")
...
TEST_F(MessageSetTest, SubmessageEncoding) {
  EXPECT_THAT(
      Testee("ValidMessageSetEncoding.SubmessageEncoding")
          .ParseBinary(
              TestAllTypesProto2::descriptor(),
...
TEST_F(MessageSetTest, SubmessageEncodingNotUnknown) {
  ...
  EXPECT_THAT(
      Testee("ValidMessageSetEncoding.SubmessageEncoding.NotUnknown")
          .ParseBinary(
              TestAllTypesProto2::descriptor(),
...
TEST_F(MessageSetTest, DuplicateDifferentTypeId) {
  EXPECT_THAT(
      Testee("ValidMessageSetEncoding.DuplicateDifferentTypeId")
          .ParseBinary(TestAllTypesProto2::descriptor(),
                       MessageSet(Item(
...
TEST_F(MessageSetTest, DuplicateValue) {
  EXPECT_THAT(
      Testee("ValidMessageSetEncoding.DuplicateValue")
          .ParseBinary(
              TestAllTypesProto2::descriptor(),
              MessageSet(Item(Wire(TypeId(kMessageSetCorrectExtension2TypeId),
                                   ItemMessage(Extension2Message(99)),
...
TEST_F(MessageSetTest, DuplicateValueOutOfOrder) {
  EXPECT_THAT(
      Testee("ValidMessageSetEncoding.DuplicateValueOutOfOrder")
          .ParseBinary(
              TestAllTypesProto2::descriptor(),
