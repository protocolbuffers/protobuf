...
#import "test_protos/TestMessagesEdition2026.pbobjc.h"
    ...
    case ConformanceRequest_Payload_OneOfCase_ProtobufPayload: {
      ...
      if ([request.messageType isEqual:@"protobuf_test_messages.proto2.TestAllTypesProto2"]) {
        ...
        registry = [EditionsTestMessagesEdition2023Root extensionRegistry];
                     ...
                     isEqual:@"protobuf_test_messages.edition2026.TestAllTypesEdition2026"]) {
        msgClass = [Edition2026TestAllTypesEdition2026 class];
        registry = [Edition2026TestMessagesEdition2026Root extensionRegistry];
      } else if ([request.messageType
                     isEqual:
