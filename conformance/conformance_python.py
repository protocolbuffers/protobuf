...
from conformance.test_protos import test_messages_edition2026_pb2
...
def _create_test_message(type):
  ...
  if type == "protobuf_test_messages.edition2026.TestAllTypesEdition2026":
    return test_messages_edition2026_pb2.TestAllTypesEdition2026()
  if (
      type
