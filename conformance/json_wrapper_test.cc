...
TEST_P(JsonWrapperTest, OptionalBoolWrapper) {
  ...
  EXPECT_THAT(Testee("OptionalBoolWrapper")
...
TEST_P(JsonWrapperTest, OptionalInt32Wrapper) {
  ...
  EXPECT_THAT(Testee("OptionalInt32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalInt32Wrapper")
...
TEST_P(JsonWrapperTest, OptionalUint32Wrapper) {
  ...
  EXPECT_THAT(Testee("OptionalUint32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalUint32Wrapper")
...
TEST_P(JsonWrapperTest, OptionalInt64Wrapper) {
  ...
  EXPECT_THAT(Testee("OptionalInt64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalInt64Wrapper")
...
TEST_P(JsonWrapperTest, OptionalUint64Wrapper) {
  ...
  EXPECT_THAT(Testee("OptionalUint64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalUint64Wrapper")
...
TEST_P(JsonWrapperTest, OptionalFloatWrapper) {
  ...
  EXPECT_THAT(Testee("OptionalFloatWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalFloatWrapper")
...
TEST_P(JsonWrapperTest, OptionalDoubleWrapper) {
  ...
  EXPECT_THAT(Testee("OptionalDoubleWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalDoubleWrapper")
...
TEST_P(JsonWrapperTest, OptionalStringWrapper) {
  ...
  EXPECT_THAT(Testee("OptionalStringWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalStringWrapper")
...
TEST_P(JsonWrapperTest, OptionalBytesWrapper) {
  ...
  EXPECT_THAT(Testee("OptionalBytesWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalBytesWrapper")
...
TEST_P(JsonWrapperTest, OptionalWrapperTypesWithNonDefaultValue) {
  ...
  EXPECT_THAT(Testee("OptionalWrapperTypesWithNonDefaultValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("OptionalWrapperTypesWithNonDefaultValue")
...
TEST_P(JsonWrapperTest, RepeatedBoolWrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedBoolWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedBoolWrapper")
...
TEST_P(JsonWrapperTest, RepeatedInt32Wrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedInt32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedInt32Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedUint32Wrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedUint32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedUint32Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedInt64Wrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedInt64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedInt64Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedUint64Wrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedUint64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedUint64Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedFloatWrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedFloatWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedFloatWrapper")
...
TEST_P(JsonWrapperTest, RepeatedDoubleWrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedDoubleWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedDoubleWrapper")
...
TEST_P(JsonWrapperTest, RepeatedStringWrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedStringWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedStringWrapper")
...
TEST_P(JsonWrapperTest, RepeatedBytesWrapper) {
  ...
  EXPECT_THAT(Testee("RepeatedBytesWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("RepeatedBytesWrapper")
...
TEST_P(JsonWrapperTest, WrapperTypesWithNullValue) {
  ...
  constexpr absl::string_view kExpected = "";
  EXPECT_THAT(Testee("WrapperTypesWithNullValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(Testee("WrapperTypesWithNullValue")
