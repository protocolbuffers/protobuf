...
ConformanceEnvironmentOptions EnvironmentOptionsFor(
  ...
  // 0 (the default) detects the protocol version; the environment's SetUp()
  // rejects anything the runner doesn't speak.
  env_options.protocol_version = options.protocol_version;
