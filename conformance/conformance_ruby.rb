...
require 'conformance/test_proto/conformance_pb'
require 'conformance/test_proto/test_messages_edition2023_pb'
require 'conformance/test_proto/test_messages_edition_unstable_pb'
