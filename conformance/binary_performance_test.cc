...
// unknown fields, or of submessages that have to be merged into one.  They
// only run with --performance (see PerformanceConformanceTest).  This replaces
// the legacy BinaryAndJsonConformanceSuiteImpl<M>::RunBinaryPerformanceTests()
...
// Parameterized over the test message type only: MessageTypeConformanceTest,
...
class MergeMessagePerformanceTest
    : public PerformanceConformanceTest,
