...
//
// This header is deliberately gtest-free: the legacy suite includes it too.
// The fixtures and INSTANTIATE_TEST_SUITE_P name generators built on top of
// these helpers live in message_type_fixtures.h.
//
