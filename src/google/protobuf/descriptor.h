...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT LazyDescriptor {
 public:
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT Descriptor
 ...
 public:
  ...
  // extensions.
  class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT ExtensionRange {
   public:
...
// Use DescriptorPool to construct your own descriptors.
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT FieldDescriptor
    : private internal::SymbolBase,
 ...
 public:
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD Label
  label() const;  // optional/required/repeated
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD bool is_optional()
      const;  // Use !is_required() && !is_repeated() instead.
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT OneofDescriptor
    : private internal::SymbolBase {
 public:
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT EnumDescriptor
    : private internal::SymbolBase {
 public:
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT EnumValueDescriptor
    : private internal::SymbolBaseN<0>,
...
// descriptors.
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT ServiceDescriptor
    : private internal::SymbolBase {
 public:
...
// own descriptors.
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT MethodDescriptor
    : private internal::SymbolBase {
 public:
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT FileDescriptor
    : private internal::SymbolBase {
 public:
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT DescriptorPool {
 public:
  ...
  class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT ErrorCollector {
   public:
