...
class PROTOBUF_EXPORT  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED
    FieldMask final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.FieldMask) */ {
 public:
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD static const FieldMask&
  default_instance() {
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD FieldMask* PROTOBUF_NONNULL
