...
class PROTOBUF_EXPORT PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED CodedInputStream {
 public:
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD void GetDirectBufferPointerInline(
      const void** data, int* size);
...
class PROTOBUF_EXPORT PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED
 ...
 public:
  ...
  PROTOBUF_NOINLINE
#endif
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD uint8_t* WriteRawMaybeAliased(
  ...
  PROTOBUF_NOINLINE
#endif
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD uint8_t* WriteStringMaybeAliased(
  ...
  PROTOBUF_NOINLINE
#endif
      PROTOBUF_FUTURE_ADD_EARLY_NODISCARD uint8_t* WriteBytes(uint32_t num,
                                                              const T& s,
                                                              uint8_t* ptr) {
...
class PROTOBUF_EXPORT PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED CodedOutputStream {
 public:
  ...
  PROTOBUF_ALWAYS_INLINE
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD static uint8_t* WriteTagToArray(
      uint32_t value, uint8_t* target);
