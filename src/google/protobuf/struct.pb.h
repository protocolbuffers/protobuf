...
PROTOBUF_EXPORT extern ListValueDefaultTypeInternal
...
PROTOBUF_EXPORT extern Struct_FieldsEntry_DoNotUseDefaultTypeInternal
...
Arena::CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Struct_FieldsEntry_DoNotUse>(
    Arena *);
template <>
PROTOBUF_EXPORT PROTOBUF_NAMESPACE_ID::Value *
Arena::CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Value>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
PROTOBUF_NAMESPACE_OPEN
...
template <typename T> inline const std::string &NullValue_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(NullValue_descriptor(),
                                                       enum_t_value);
}
...
class PROTOBUF_EXPORT Struct : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Struct)
                                                                        */
{
public:
  Struct();
...
class PROTOBUF_EXPORT Value : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Value)
                                                                       */
{
public:
  Value();
...
class PROTOBUF_EXPORT ListValue : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.protobuf.ListValue)
                                                                           */
{
public:
  ListValue();
...
inline void
Value::_internal_set_null_value(PROTOBUF_NAMESPACE_ID::NullValue value) {
  if (!_internal_has_null_value()) {
    clear_kind();
    set_has_null_value();
  }
...
Value::_internal_struct_value() const {
  return _internal_has_struct_value()
             ? *kind_.struct_value_
...
inline PROTOBUF_NAMESPACE_ID::Struct *Value::_internal_mutable_struct_value() {
  if (!_internal_has_struct_value()) {
    ...
    set_has_struct_value();
    kind_.struct_value_ =
        CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Struct>(GetArenaNoVirtual());
  }
...
inline bool Value::has_list_value() const { return _internal_has_list_value(); }
...
Value::_internal_list_value() const {
  return _internal_has_list_value()
             ? *kind_.list_value_
             : *reinterpret_cast<PROTOBUF_NAMESPACE_ID::ListValue *>(
...
ListValue::_internal_values(int index) const {
