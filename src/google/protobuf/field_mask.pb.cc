...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable *const
    descriptor_table_google_2fprotobuf_2ffield_5fmask_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase
    *const descriptor_table_google_2fprotobuf_2ffield_5fmask_2eproto_sccs[1] = {
...
void FieldMask::SharedDtor() { GOOGLE_DCHECK(GetArenaNoVirtual() == nullptr); }
...
void FieldMask::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
size_t FieldMask::ByteSizeLong() const {
  ...
  // repeated string paths = 1;
  total_size +=
      1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(paths_.size());
...
void FieldMask::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message &from) {
  ...
  const FieldMask *source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<FieldMask>(&from);
  if (source == nullptr) {
...
bool FieldMask::IsInitialized() const { return true; }
