...
class RustMapHelper {
 public:
  ...
  static uint32_t Size(const google::protobuf::MessageLite* m) {
    return m->GetClassData()->allocation_size();
  }

  static uint32_t Alignment(const google::protobuf::MessageLite* m) {
    return m->GetClassData()->alignment();
  }
