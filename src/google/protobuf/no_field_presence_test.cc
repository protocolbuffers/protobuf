...
template <>
class NoFieldPresenceSerializeTest<std::string> : public testing::Test {
 public:
  std::string& GetOutputSinkRef() { return value_; }
  const std::string& GetOutput() { return value_; }
...
template <>
class NoFieldPresenceSerializeTest<absl::Cord> : public testing::Test {
 public:
  absl::Cord& GetOutputSinkRef() { return value_; }
  std::string GetOutput() { return std::string{value_}; }

 protected:
  using List = std::list<absl::Cord>;
  absl::Cord value_;
};
