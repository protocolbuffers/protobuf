...
class PROTOBUF_EXPORT  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED
    SourceContext final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.SourceContext) */ {
 public:
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD static const SourceContext&
  default_instance() {
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD SourceContext* PROTOBUF_NONNULL
