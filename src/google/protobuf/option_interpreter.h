...
class OptionInterpreter {
 ...
 private:
  ...
  // Maps the source code path of an uninterpreted dot-notation option to its
  // legacy destination path (which directly appends field numbers without
  // aggregate markers), preserved for backwards compatibility.
  absl::flat_hash_map<SourceCodePath, SourceCodePath>
      legacy_dot_notation_paths_;
