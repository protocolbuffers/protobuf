...
void FileDescriptorProto::CheckTypeAndCopyFrom(
  ...
  #ifndef NDEBUG
  std::cerr << "CopyFrom 'options'\n";
  #endif
  // Message: options
  if (rhs._impl_.options_ != nullptr) {
    _internal_mutable_options()->CheckTypeAndCopyFrom(*rhs._impl_.options_);
  } else if (_impl_.options_ != nullptr) {
    _impl_.options_->Clear();
  }
  #ifndef NDEBUG
  std::cerr << "CopyFrom 'source_code_info'\n";
  #endif
  // Message: source_code_info
  if (rhs._impl_.source_code_info_ != nullptr) {
    _internal_mutable_source_code_info()->CheckTypeAndCopyFrom(*rhs._impl_.source_code_info_);
...
void MethodDescriptorProto::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [client_streaming...server_streaming]: (2)
...
void FileOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [java_multiple_files...cc_enable_arenas]: (10)
...
void MessageOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [message_set_wire_format...deprecated_legacy_json_field_conflicts]: (5)
...
void FieldOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [ctype...target_obsolete_do_not_use]: (10)
...
void EnumOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [allow_alias...deprecated_legacy_json_field_conflicts]: (3)
...
void EnumValueOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [deprecated...debug_redact]: (2)
...
void MethodOptions::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [deprecated...idempotency_level]: (2)
  memcpy(&_impl_.deprecated_, &rhs._impl_.deprecated_,
...
void UninterpretedOption::CheckTypeAndCopyFrom(
  ...
  auto arena = GetArenaForAllocation();
  // Fields [positive_int_value...double_value]: (3)
