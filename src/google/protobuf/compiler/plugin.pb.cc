  ...
  ::_pbi::Prefetch5LinesFrom7Lines(&this_);
   {
    // repeated string file_to_generate = 1;
    {
      total_size += ::_pbi::WireFormatLite::RepeatedStringByteSizeV2(
          this_._internal_file_to_generate());
    }
    // repeated .google.protobuf.FileDescriptorProto proto_file = 15;
    {
    ...
    {
      total_size += ::_pbi::WireFormatLite::RepeatedMessageByteSizeV2(
          this_._internal_source_file_descriptors());
    }
  }
  cached_has_bits = this_._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += ::_pbi::WireFormatLite::LengthPrefixedByteSizeV2(
          this_._internal_parameter().size());
    }
    // optional .google.protobuf.compiler.Version compiler_version = 3;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::_pbi::WireFormatLite::LengthPrefixedByteSizeV2(
          this_._impl_.compiler_version_->ByteSizeV2Message());
    }
  }
  return this_.MaybeComputeUnknownFieldsSize(total_size,
                                             &this_._impl_._cached_size_);
...
::size_t CodeGeneratorResponse_File::ByteSizeV2MessageImpl(const MessageLite& base) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += ::_pbi::WireFormatLite::LengthPrefixedByteSizeV2(
          this_._internal_insertion_point().size());
    }
    // optional string content = 15;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::_pbi::WireFormatLite::LengthPrefixedByteSizeV2(
          this_._internal_content().size());
    }
    // optional .google.protobuf.GeneratedCodeInfo generated_code_info = 16;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::_pbi::WireFormatLite::LengthPrefixedByteSizeV2(
          this_._impl_.generated_code_info_->ByteSizeV2Message());
    }
  }
  return this_.MaybeComputeUnknownFieldsSize(total_size,
                                             &this_._impl_._cached_size_);
