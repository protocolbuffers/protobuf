...
const ::_pbi::TcParseTable<2, 4, 0, 47, 2> Version::_table_ = {
  ...
  if (cached_has_bits & 0x0000000eu) {
    ::memset(&this_._impl_.major_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&this_._impl_.major_)) + sizeof(this_._impl_.patch_));
  }
...
const ::_pbi::TcParseTable<3, 5, 1, 60, 2> CodeGeneratorResponse::_table_ = {
  ...
  if (cached_has_bits & 0x0000000eu) {
    ::memset(&this_._impl_.supported_features_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&this_._impl_.supported_features_)) + sizeof(this_._impl_.maximum_edition_));
  }
  this_._impl_._has_bits_.Clear();
  this_._internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
