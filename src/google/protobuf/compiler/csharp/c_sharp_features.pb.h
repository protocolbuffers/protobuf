...
/* @@protoc_insertion_point(class_definition:pb.CSharpFeatures) */ {
 ...
 public:
  ...
  inline CSharpFeatures& operator=(CSharpFeatures&& from) noexcept {
    ...
    if (::google::protobuf::internal::CanMoveWithInternalSwap(GetArena(), from.GetArena())) {
      _Helpers::InternalSwap(*this, &from);
    } else {
      CopyFrom(from);
    }
    return *this;
  ...
  inline void Swap(CSharpFeatures* PROTOBUF_NONNULL other) {
    ...
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      _Helpers::InternalSwap(*this, other);
    } else {
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const CSharpFeatures& from) {
    CSharpFeatures::_Helpers::MergeImpl(*this, from);
  }
 ...
 private:
  ...
  struct _Helpers {
    ...
    static constexpr CSharpFeatures::ParseTableT_ InternalGenerateParseTable_(
  ...
  friend CSharpFeaturesGlobalsTypeInternal;
  template <typename T>
