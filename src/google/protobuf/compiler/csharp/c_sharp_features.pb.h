...
/* @@protoc_insertion_point(class_definition:pb.CSharpFeatures) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void CopyFrom(const CSharpFeatures& from) {
    CSharpFeatures::Helpers_::CopyImpl(*this, from);
  }
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const CSharpFeatures& from) {
    CSharpFeatures::Helpers_::MergeImpl(*this, from);
  }
