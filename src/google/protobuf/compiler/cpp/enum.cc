...
void EnumGenerator::GenerateDefinition(io::Printer* p) {
  ...
  if (has_reflection_) {
    p->Emit(R"cc(
      inline bool $Msg_Enum$_Parse(absl::string_view name,
                                   $Msg_Enum$* PROTOBUF_NONNULL value) {
    ...
    p->Emit(R"cc(
      bool $Msg_Enum$_Parse(absl::string_view name,
                            $Msg_Enum$* PROTOBUF_NONNULL value);
    )cc");
  }
}
...
void EnumGenerator::GenerateSymbolImports(io::Printer* p) const {
  ...
  if (has_reflection_) {
    p->Emit(R"cc(
      static inline const ::$proto_ns$::EnumDescriptor* PROTOBUF_NONNULL
      $Enum$_descriptor() {
        return $Msg_Enum$_descriptor();
      }
    )cc");
  ...
  p->Emit(R"cc(
    ...
    static inline bool $Enum$_Parse(absl::string_view name,
                                    $Enum_$* PROTOBUF_NONNULL value) {
...
void EnumGenerator::GenerateMethods(int idx, io::Printer* p) {
  ...
  if (has_reflection_) {
    p->Emit({{"idx", idx}}, R"cc(
      const ::$proto_ns$::EnumDescriptor* PROTOBUF_NONNULL
      $Msg_Enum$_descriptor() {
