...
class OneofMessage : public SingularMessage {
 public:
  ...
  bool use_base_class() const {
    // This value is a tradeoff. We want to allow optimizations like inlining on
    // small oneofs or hot alternatives. DO NOT SUBMIT test it.
    static constexpr int kMaxStaticTypeCount = 3;
    return is_weak() || (num_message_fields_in_oneof_ >= kMaxStaticTypeCount &&
