...
TEST(FileTest, TopologicallyOrderedDescriptors) {
  ...
  // Let's use a string to get nice diff output on failures.
  const std::string kExpectedDescriptorOrder = absl::StrJoin(
      {
          "Uint64Message",
          "Uint32Message",
          ...
          "OpenEnumMessage",
          "OneofGroupingTestProto.M4",
          "OneofGroupingTestProto.M3",
          "OneofGroupingTestProto.M2",
          "OneofGroupingTestProto.M1",
          "OneofGroupingTestProto.ByteSizeFixed",
          "OneofGroupingTestProto",
          "OneString",
          "OneBytes",
          "MoreString",
          "MoreBytes",
          ...
          "TestAllTypes",
          "RedactedFields",
          "OneofGroupingTestProto.ManyMessages",
          "OneofGroupingTestProto.Basic",
