  ...
  printer->Emit(
      ...
      R"cc(
        ...
        class $dllexport_decl $$classname$_Stub final : public $classname$ {
         public:
          //~ It seems this should be nonnull, but some tests use nullptr
          //~ TODO: clean up and switch to nonnull.
          $classname$_Stub(::$proto_ns$::RpcChannel* $nullable$ channel);
          $classname$_Stub(::$proto_ns$::RpcChannel* $nullable$ channel,
          ...
          inline ::$proto_ns$::RpcChannel* $nullable$ channel() { return channel_; }
...
void ServiceGenerator::GenerateMethodSignatures(VirtualOrNot virtual_or_not,
  ...
  for (int i = 0; i < descriptor_->method_count(); ++i) {
    ...
    printer->Emit(
        ...
        // It seems controller should be nonnull, but some tests use nullptr
        // TODO: clean up and switch to nonnull.
        R"(
          $virtual $void $name$(::$proto_ns$::RpcController* $nullable$ controller,
...
void ServiceGenerator::GenerateImplementation(io::Printer* printer) {
  ...
  printer->Emit(
      ...
      R"cc(
        ...
        //~ It seems channel should be nonnull, but some tests use nullptr
        //~ TODO: clean up and switch to nonnull.
        $classname$_Stub::$classname$_Stub(
            ::$proto_ns$::RpcChannel* $nullable$ channel)
...
void ServiceGenerator::GenerateNotImplementedMethods(io::Printer* printer) {
  for (int i = 0; i < descriptor_->method_count(); ++i) {
    ...
    printer->Emit(
        ...
        R"cc(
          void $classname$::$name$(
              ::$proto_ns$::RpcController* PROTOBUF_NULLABLE controller,
