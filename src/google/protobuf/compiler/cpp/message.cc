      ...
      R"cc(
        class $classname$ final
         ...
         public:
          ...
          explicit $classname$(::$proto_ns$::Arena* PROTOBUF_NULLABLE arena);
          static const $classname$* PROTOBUF_NONNULL internal_default_instance() {
         ...
         private:
          ...
          const $pbi$::ClassData* PROTOBUF_NONNULL GetClassData() const PROTOBUF_FINAL;
          static void* PROTOBUF_NONNULL PlacementNew_(
              const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
              ::$proto_ns$::Arena* PROTOBUF_NULLABLE arena);
        ...
        [&] {
          ...
          p->Emit({{"split_field",
                  ...
                  R"cc(
                    ...
                    Split* PROTOBUF_NONNULL _split_;
                  )cc");
        }},
       {"oneof_members",
        [&] {
      ...
      R"cc(
        struct Impl_ {
          ...
          inline explicit Impl_(
              //~
              $pbi$::InternalVisibility visibility,
              ::$proto_ns$::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
      ...
      {{"decl_dtor",
       ...
       {"descriptor_accessor",
        [&] {
          ...
          p->Emit(R"cc(
            static const ::$proto_ns$::Descriptor* $nnull$ descriptor() {
       ...
       {"get_descriptor",
        [&] {
          ...
          p->Emit(R"cc(
            static const ::$proto_ns$::Descriptor* $nnull$ GetDescriptor() {
              return default_instance().GetMetadata().descriptor;
            }
            static const ::$proto_ns$::Reflection* $nnull$ GetReflection() {
        ...
        [&] {
          ...
          if (!HasSimpleBaseClass(descriptor_, options_)) {
            ...
            p->Emit(R"cc(
              ...
              static $uint8$* $nnull$ _InternalSerialize(
                  const MessageLite& msg, $uint8$* $nnull$ target,
                  ::$proto_ns$::io::EpsCopyOutputStream* $nnull$ stream);

              public:
              ::size_t ByteSizeLong() const { return ByteSizeLong(*this); }
              $uint8$* $nnull$ _InternalSerialize(
                  $uint8$* $nnull$ target,
                  ::$proto_ns$::io::EpsCopyOutputStream* $nnull$ stream) const {
              ...
              $uint8$* $nnull$ _InternalSerialize(
                  //~
                  $uint8$* $nnull$ target,
                  ::$proto_ns$::io::EpsCopyOutputStream* $nnull$
                      stream) const final;
        ...
        [&] {
          ...
          p->Emit(
              R"cc(
                ...
                private:
                void SharedCtor(::$proto_ns$::Arena* PROTOBUF_NULLABLE arena);
                static void SharedDtor(MessageLite& self);
                void InternalSwap($classname$* $nnull$ other);
              )cc");
        }},
       {"arena_dtor",
        [&] {
          switch (NeedsArenaDestructor()) {
            case ArenaDtorNeeds::kOnDemand:
              p->Emit(R"cc(
                private:
                static void ArenaDtor(void* $nnull$ object);
       ...
       {"post_loop_handler",
        [&] {
          ...
          p->Emit(R"cc(
            static const char* PROTOBUF_NULLABLE PostLoopHandler(
                MessageLite* $nnull$ msg, const char* PROTOBUF_NULLABLE ptr,
                $pbi$::ParseContext* $nnull$ ctx);
          )cc");
        }},
      ...
      R"cc(
        ...
        /* @@protoc_insertion_point(class_definition:$full_name$) */ {
         public:
          ...
          void operator delete($classname$* $nnull$ msg, std::destroying_delete_t) {
            SharedDtor(*msg);
          ...
          inline $unknown_fields_type$* $nnull$ mutable_unknown_fields()
              ABSL_ATTRIBUTE_LIFETIME_BOUND {
          ...
          inline void Swap($classname$* $nnull$ other) {
          ...
          void UnsafeArenaSwap($classname$* $nnull$ other) {
            if (other == this) return;
          ...
          $classname$* $nnull$
          New(::$proto_ns$::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
         ...
         protected:
          ...
          $arena_dtor$;
          const $pbi$::ClassData* $nnull$ GetClassData() const PROTOBUF_FINAL;
          static void* $nnull$ PlacementNew_(
              //~
              const void* $nnull$, void* $nnull$ mem,
              ::$proto_ns$::Arena* PROTOBUF_NULLABLE arena);
          static constexpr auto InternalNewImpl_();
  ...
  if (IsMapEntryMessage(descriptor_)) {
    p->Emit(
        ...
        R"cc(
          ...
          $classname$::$classname$(::$proto_ns$::Arena* PROTOBUF_NULLABLE arena)
       ...
       {"post_loop_handler",
        [&] {
          ...
          p->Emit({{"required",
                  ...
                  R"cc(
                    const char* PROTOBUF_NULLABLE $classname$::PostLoopHandler(
                        MessageLite* PROTOBUF_NONNULL msg,
                        const char* PROTOBUF_NULLABLE ptr,
                        ::_pbi::ParseContext* PROTOBUF_NONNULL ctx) {
...
void MessageGenerator::GenerateSharedConstructorCode(io::Printer* p) {
  ...
  p->Emit({{"init_impl", [&] { GenerateImplMemberInit(p, InitType::kArena); }},
          ...
          R"cc(
            ...
            inline void $classname$::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
void MessageGenerator::GenerateArenaDestructorCode(io::Printer* p) {
  ...
  p->Emit(
      ...
      R"cc(
        void $classname$::ArenaDtor(void* PROTOBUF_NONNULL object) {
...
void MessageGenerator::GenerateStructors(io::Printer* p) {
  ...
  if (UsingImplicitWeakFields(descriptor_->file(), options_)) {
    ...
    p->Emit(R"cc(
      $classname$::$classname$(
          //~ Force alignment
          ::$proto_ns$::Arena* PROTOBUF_NULLABLE arena, const $classname$& from)
          : $classname$(arena) {
        MergeFrom(from);
      }
    )cc");
...
void MessageGenerator::GenerateSourceInProto2Namespace(io::Printer* p) {
  ...
  if (ShouldGenerateExternSpecializations(options_) &&
    ...
    // clang-format off
    p->Emit(R"cc(
      template void* PROTOBUF_NONNULL Arena::DefaultConstruct<$classtype$>(Arena* PROTOBUF_NULLABLE);
    )cc");
    // clang-format on
    if (!IsMapEntryMessage(descriptor_)) {
      // clang-format off
      p->Emit(R"cc(
        template void* PROTOBUF_NONNULL Arena::CopyConstruct<$classtype$>(Arena* PROTOBUF_NULLABLE, const void* PROTOBUF_NONNULL);
      )cc");
      // clang-format on
    }
  }
...
void MessageGenerator::GenerateClassData(io::Printer* p) {
  ...
  p->Emit(R"cc(
    inline void* PROTOBUF_NONNULL $classname$::PlacementNew_(
        const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
        ::$proto_ns$::Arena* PROTOBUF_NULLABLE arena) {
  ...
  if (HasDescriptorMethods(descriptor_->file(), options_)) {
    ...
    p->Emit(
        ...
        R"cc(
          ...
          const $pbi$::ClassData* PROTOBUF_NONNULL $classname$::GetClassData() const {
            $pin_weak_descriptor$;
...
void MessageGenerator::GenerateSerializeWithCachedSizesToArray(io::Printer* p) {
  ...
  if (descriptor_->options().message_set_wire_format()) {
    ...
    p->Emit(R"cc(
#if defined(PROTOBUF_CUSTOM_VTABLE)
      $uint8$* PROTOBUF_NONNULL $classname$::_InternalSerialize(
          const MessageLite& base, $uint8$* PROTOBUF_NONNULL target,
          ::$proto_ns$::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
        const $classname$& this_ = static_cast<const $classname$&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
      $uint8$* PROTOBUF_NONNULL $classname$::_InternalSerialize(
          $uint8$* PROTOBUF_NONNULL target,
          ::$proto_ns$::io::EpsCopyOutputStream* PROTOBUF_NONNULL
              stream) const {
