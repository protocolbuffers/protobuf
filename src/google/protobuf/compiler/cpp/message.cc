        ...
        [&] {
          ...
          if (!HasSimpleBaseClass(descriptor_, options_)) {
            ...
            p->Emit(R"cc(
              ...
              private:
              static void ClearImpl($pb$::MessageLite& msg);
              $nodiscard $static::size_t ByteSizeLongImpl(const $pb$::MessageLite& msg);
              $nodiscard $static $uint8$* $nonnull$ _InternalSerializeImpl(
...
void MessageGenerator::GenerateClear(io::Printer* p) {
  ...
  p->Emit(
      ...
      R"cc(
#if defined(PROTOBUF_CUSTOM_VTABLE)
        PROTOBUF_NOINLINE void $Msg$::ClearImpl(MessageLite& base) {
...
void MessageGenerator::GenerateSerializeWithCachedSizesToArray(io::Printer* p) {
  ...
  if (descriptor_->options().message_set_wire_format()) {
    ...
    p->Emit(R"cc(
#if defined(PROTOBUF_CUSTOM_VTABLE)
      $uint8$* $nonnull$ $Msg$::_InternalSerializeImpl(
