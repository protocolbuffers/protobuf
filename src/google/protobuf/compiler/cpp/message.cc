...
void MessageGenerator::GenerateMapEntryClassDefinition(io::Printer* p) {
  ...
  p->Emit(
      {{"decl_verify_func",
       ...
       {"maybe_is_initialized_trampoline",
        [&] {
        ...
        class $unused $$Msg$ final
         ...
         private:
          ...
          struct Helpers_ {
            ...
            static constexpr auto& SharedDtor = Super_::SharedDtor;
      ...
      {Sub{"superclass",
       ...
       {"public_generated_methods",
        [&] {
          ...
          } else if (!HasSimpleBaseClass(descriptor_, options_)) {
...
void MessageGenerator::GenerateNewOp(io::Printer* p) const {
  ...
  if (new_op.needs_to_run_constructor) {
    p->Emit(R"cc(
      constexpr auto $Msg$::Helpers_::InternalNewImpl_() {
        return $pbi$::MessageCreator(&$Msg$::Helpers_::PlacementNew_,
...
void MessageGenerator::GenerateInternalGenerateClassData(io::Printer* p) {
  ...
  if (HasDescriptorMethods(descriptor_->file(), options_)) {
    p->Emit(
        ...
        R"cc(
          constexpr auto $Msg$::Helpers_::InternalGenerateClassData_() {
...
void MessageGenerator::GenerateSourceDefaultInstance(io::Printer* p) {
    ...
    p->Emit({{"has_bit",
              [&] {
                ...
                p->Emit(
                    R"cc(
                      using HasBits =
                          decltype(::std::declval<$Msg$>().$has_bits$);
  ...
  p->Emit(R"cc(
    inline void* $nonnull$ $Msg$::Helpers_::PlacementNew_(
        //~
      ...
      R"cc(
        struct $globals_type$ : ::_pbi::MessageGlobalsBase {
          $constexpr$ $globals_type$()
              : MessageGlobalsBase(
                    $Msg$::Helpers_::InternalGenerateClassData_()),
                _default(::_pbi::ConstantInitialized{}, GetClassData()),
                _table($Msg$::_Internal::GenerateParseTable(GetClassData())) {}
          ...
          decltype($Msg$::_Internal::GenerateParseTable(
