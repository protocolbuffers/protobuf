       ...
       {"maybe_is_initialized_trampoline",
        [&] {
          if (NeedsIsInitialized()) {
            p->Emit(R"cc(
              PROTOBUF_ALWAYS_INLINE_NODEBUG static bool IsInitializedImpl(
                  const MessageLite& msg) {
                return Super_::IsInitializedImpl(msg);
              }
            )cc");
          }
        }}},
         ...
         private:
          ...
          struct _Helpers {
            ...
            PROTOBUF_ALWAYS_INLINE_NODEBUG static void MergeImpl(
                $pb$::MessageLite& to_msg, const $pb$::MessageLite& from_msg) {
              Super_::MergeImpl(to_msg, from_msg);
            }
            $maybe_is_initialized_trampoline$;
          };
          ...
          if (!HasDescriptorMethods(descriptor_->file(), options_)) {
            p->Emit(R"cc(
              ...
              PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const $Msg$& from) {
                $Msg$::_Helpers::MergeImpl(*this, from);
              }
            )cc");
...
void MessageGenerator::GenerateInternalGenerateClassData(io::Printer* p) {
  const auto is_initialized = [&] {
    if (NeedsIsInitialized()) {
      p->Emit(R"cc(
        $Msg$::_Helpers::IsInitializedImpl,
      )cc");
    } else {
      p->Emit(R"cc(
...
void MessageGenerator::GenerateClassSpecificMergeImpl(io::Printer* p) {
  ...
  p->Emit(
      ...
      R"cc(
        void $Msg$::_Helpers::MergeImpl($pb$::MessageLite& to_msg,
                                        const $pb$::MessageLite& from_msg) {
...
void MessageGenerator::GenerateIsInitialized(io::Printer* p) {
  ...
  p->Emit(
      ...
      R"cc(
        PROTOBUF_NOINLINE bool $Msg$::_Helpers::IsInitializedImpl(
            const MessageLite& msg) {
