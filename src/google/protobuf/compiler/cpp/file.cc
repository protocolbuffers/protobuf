...
void FileGenerator::GenerateFile(io::Printer* p, GeneratedFileType file_type,
  ...
  p->Print("\n");
  if (file_type == GeneratedFileType::kProtoFwdH) {
    p->Print("// NOLINTBEGIN\n");
  }
  p->Emit({{"cb", cb},
           {"guard", guard},
           {"header_guard_nolint", file_type == GeneratedFileType::kProtoFwdH
                                       ? "  // NOLINT(build/header_guard)"
                                       : ""}},
          R"(
    #ifndef $guard$$header_guard_nolint$
    #define $guard$
    ...
    #endif  // $guard$$header_guard_nolint$
  )");
  if (file_type == GeneratedFileType::kProtoFwdH) {
    p->Print("// NOLINTEND\n");
  }
