...
TEST_F(ParseMessageTest, Varint32Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { varint32 value = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Varint64Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { varint64 int64_field = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "int64_field"
...
TEST_F(ParseMessageTest, Zigzag32Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { zigzag32 sint32_field = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "sint32_field"
...
TEST_F(ParseMessageTest, Zigzag64Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { zigzag64 sint64_field = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "sint64_field"
...
TEST_F(ParseMessageTest, Uvarint32Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { uvarint32 uint32_field = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "uint32_field"
...
TEST_F(ParseMessageTest, Uvarint64Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message NewVarintTypes { uvarint64 uint64_field = 1; })cc",
      R"pb(message_type {
             name: "NewVarintTypes"
             field {
               name: "uint64_field"
...
TEST_F(ParseMessageTest, UInt32Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message Test { uint32 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, UInt64Unstable) {
  ExpectParsesTo(
      R"cc(edition = "UNSTABLE";
           message Test { uint64 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Fixed32Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { fixed32 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Fixed64Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { fixed64 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Sfixed32Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { sfixed32 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Sfixed64Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { sfixed64 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Sint32Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { sint32 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
...
TEST_F(ParseMessageTest, Sint64Edition2024) {
  ExpectParsesTo(
      R"cc(edition = "2024";
           message Test { sint64 value = 1; })cc",
      R"pb(message_type {
             name: "Test"
             field {
               name: "value"
