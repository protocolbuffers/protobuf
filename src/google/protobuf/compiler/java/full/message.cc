...
void ImmutableMessageGenerator::GenerateAnyMethods(io::Printer* printer) {
  printer->Print(
      ...
      "\n"
      "/**\n"
      " * Packs a message, declaring that the set of extensions it might have\n"
      " * concrete values for is represented by the given extension registry.\n"
      " *\n"
      " * You should pass whatever extension registry you use for parsing\n"
      " * here.\n"
      " */\n"
      "public static <T extends com.google.protobuf.Message> Any pack(\n"
      "    T message, ExtensionRegistryLite extensionRegistry) {\n"
      "  return Any.newBuilder()\n"
      "      .setTypeUrl(getTypeUrl(\"type.googleapis.com\",\n"
      "                             message.getDescriptorForType()))\n"
      "      .setValue(message.toByteString())\n"
      ...
      "  return pack(message, typeUrlPrefix, EMPTY_REGISTRY);\n"
      "}\n"
      "\n"
      "/**\n"
      " * Packs a message using the given type URL prefix. The type URL will\n"
      ...
      " * with \"/\" already.\n"
      " *\n"
      " * This method also declares that the set of extensions it might have\n"
      " * concrete values for is represented by the given extension registry.\n"
      " *\n"
      " * You should pass whatever extension registry you use for parsing\n"
      " * here.\n"
      ...
      "\n"
      "@SuppressWarnings(\"serial\")\n"
      "private volatile CachedUnpackValue cachedUnpackValue;\n"
      "\n"
  ...
  printer->Print(
      ...
      "    if (cachedUnpackValue.message.getClass() != clazz) {\n"
      "      invalidClazz = true;\n"
      "    } else if (cachedUnpackValue.extensionRegistry == "
      "        EMPTY_REGISTRY) {\n"
      "      return (T) cachedUnpackValue.message;\n"
      "    }\n"
      "  }\n"
      ...
      "      .parseFrom(value);\n"
      "    cachedUnpackValue ="
      "      new CachedUnpackValue(result, EMPTY_REGISTRY);\n"
      "  return result;\n"
      "}\n"
      "\n"
      "@java.lang.SuppressWarnings(\"unchecked\")\n"
      "public <T extends com.google.protobuf.Message> T unpack(\n"
      "    java.lang.Class<T> clazz, ExtensionRegistryLite extensionRegistry)\n"
      "    throws com.google.protobuf.InvalidProtocolBufferException {\n");
  printer->Print(
      "  boolean invalidClazz = false;\n"
      "  if (cachedUnpackValue != null) {\n"
      ...
      "      com.google.protobuf.Internal.getDefaultInstance(clazz);\n"
      "  T result = (T) defaultInstance.getParserForType()\n"
      "      .parseFrom(value, extensionRegistry);\n"
      "    cachedUnpackValue ="
      "      new CachedUnpackValue(result, extensionRegistry);\n"
      "  return result;\n"
      "}\n"
      "\n"
      "@java.lang.SuppressWarnings(\"unchecked\")\n"
  ...
  printer->Print(
      ...
      "  if (cachedUnpackValue != null) {\n"
      "    if (cachedUnpackValue.message.getClass() != message.getClass()) {\n"
      "      invalidValue = true;\n"
      "    } else if (cachedUnpackValue.extensionRegistry == "
      "        EMPTY_REGISTRY) {\n"
      "      return (T) cachedUnpackValue.message;\n"
      ...
      "  }\n"
      "  ByteString value = getValue();\n"
      "  T result = (T) message.getParserForType().parseFrom(value);\n"
      "    cachedUnpackValue ="
      "      new CachedUnpackValue(result, EMPTY_REGISTRY);\n"
      "  return result;\n"
      "}\n"
  ...
  printer->Print(
      ...
      "  }\n"
      "  ByteString value = getValue();\n"
      "  T result = (T) message.getParserForType().parseFrom(\n"
