...
const ::google::protobuf::internal::ClassData* JavaFeatures::GetClassData()
    const {
...
::uint8_t* JavaFeatures::_InternalSerialize(
  ...
  // optional bool legacy_closed_enum = 1 [retention = RETENTION_RUNTIME,
  // targets = TARGET_TYPE_FIELD, targets = TARGET_TYPE_FILE, edition_defaults =
  // {
  ...
  // optional .pb.JavaFeatures.Utf8Validation utf8_validation = 2 [retention =
  // RETENTION_RUNTIME, targets = TARGET_TYPE_FIELD, targets = TARGET_TYPE_FILE,
  // edition_defaults = {
