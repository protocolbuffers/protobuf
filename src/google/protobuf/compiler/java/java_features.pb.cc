...
#if defined(PROTOBUF_CUSTOM_VTABLE)
PROTOBUF_NOINLINE void JavaFeatures::ClearImpl(MessageLite& base) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL JavaFeatures::_InternalSerializeImpl(
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t JavaFeatures::ByteSizeLongImpl(const MessageLite& base) {
  const JavaFeatures& this_ = static_cast<const JavaFeatures&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
