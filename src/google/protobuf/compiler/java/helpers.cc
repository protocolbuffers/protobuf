...
inline bool NestInFileClass(const Descriptor& descriptor) {
  // TODO: b/373884685 - Remove this once all the call cites pass in descriptors
  // with Java feature resolved..
  ...
  // if (nest_in_file_class == pb::JavaFeatures::NEST_IN_FILE_CLASS_UNKNOWN) {
  //   std::cerr << "MMP AAA \n"
  //           << nest_in_file_class << "\n"
  //           << descriptor.file()->name() << "\n";
  // }
