...
PROTOC_EXPORT extern const uint32_t JavaFeatures_NestInFileClass_internal_data_[];
inline constexpr JavaFeatures_NestInFileClass JavaFeatures_NestInFileClass_NestInFileClass_MIN =
    static_cast<JavaFeatures_NestInFileClass>(0);
inline constexpr JavaFeatures_NestInFileClass JavaFeatures_NestInFileClass_NestInFileClass_MAX =
    static_cast<JavaFeatures_NestInFileClass>(3);
inline bool JavaFeatures_NestInFileClass_IsValid(int value) {
  return 0 <= value && value <= 3;
}
inline constexpr int JavaFeatures_NestInFileClass_NestInFileClass_ARRAYSIZE = 3 + 1;
PROTOC_EXPORT const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL JavaFeatures_NestInFileClass_descriptor();
template <typename T>
...
inline const std::string& JavaFeatures_NestInFileClass_Name(JavaFeatures_NestInFileClass value) {
  return ::google::protobuf::internal::NameOfDenseEnum<JavaFeatures_NestInFileClass_descriptor, 0, 3>(
      static_cast<int>(value));
}
inline bool JavaFeatures_NestInFileClass_Parse(
    absl::string_view name, JavaFeatures_NestInFileClass* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<JavaFeatures_NestInFileClass>(JavaFeatures_NestInFileClass_descriptor(), name,
                                           value);
}
...
inline void JavaFeatures::_internal_set_nest_in_file_class(::pb::JavaFeatures_NestInFileClass value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
                                          ...
                                          assert(::google::protobuf::internal::ValidateEnum(
                                              value, ::pb::JavaFeatures_NestInFileClass_internal_data_));
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::pb::JavaFeatures_NestInFileClass>() {
