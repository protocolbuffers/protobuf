...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures.NestInFileClassFeature) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const JavaFeatures_NestInFileClassFeature& from) {
    Super_::_Helpers::MergeImpl(*this, from);
  }
 ...
 private:
  ...
  struct _Helpers {
    ...
    PROTOBUF_ALWAYS_INLINE_NODEBUG static void MergeImpl(
        ::google::protobuf::MessageLite& to_msg,
        const ::google::protobuf::MessageLite& from_msg) {
      Super_::_Helpers::MergeImpl(to_msg, from_msg);
    }
...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const JavaFeatures& from) {
    JavaFeatures::_Helpers::MergeImpl(*this, from);
  }
  [[nodiscard]] PROTOBUF_ALWAYS_INLINE_NODEBUG bool IsInitialized()
      const {
    return true;
