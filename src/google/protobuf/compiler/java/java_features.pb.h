...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures.NestInFileClassFeature) */ {
 ...
 private:
  ...
  friend class ::google::protobuf::internal::MessageWithArena<JavaFeatures_NestInFileClassFeature>;
...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures) */ {
 ...
 private:
  ...
  friend class ::google::protobuf::MessageLite;
  friend class ::google::protobuf::Arena;
  friend class ::google::protobuf::internal::MessageWithArena<JavaFeatures>;
  friend ::google::protobuf::internal::PrivateAccess;
  template <typename T>
  friend class ::google::protobuf::Arena::InternalHelper;
  using InternalArenaConstructable_ = void;
