...
PROTOC_EXPORT extern const uint32_t JavaFeatures_NestInFileClass_internal_data_[];
...
PROTOC_EXPORT bool JavaFeatures_NestInFileClass_IsValid(int value);
PROTOC_EXPORT extern const uint32_t JavaFeatures_NestInFileClass_internal_data_[];
constexpr JavaFeatures_NestInFileClass JavaFeatures_NestInFileClass_NestInFileClass_MIN = static_cast<JavaFeatures_NestInFileClass>(0);
constexpr JavaFeatures_NestInFileClass JavaFeatures_NestInFileClass_NestInFileClass_MAX = static_cast<JavaFeatures_NestInFileClass>(3);
constexpr int JavaFeatures_NestInFileClass_NestInFileClass_ARRAYSIZE = 3 + 1;
PROTOC_EXPORT const ::google::protobuf::EnumDescriptor*
...
const std::string& JavaFeatures_NestInFileClass_Name(T value) {
  ...
  return JavaFeatures_NestInFileClass_Name(static_cast<JavaFeatures_NestInFileClass>(value));
}
template <>
inline const std::string& JavaFeatures_NestInFileClass_Name(JavaFeatures_NestInFileClass value) {
  return ::google::protobuf::internal::NameOfDenseEnum<JavaFeatures_NestInFileClass_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool JavaFeatures_NestInFileClass_Parse(absl::string_view name, JavaFeatures_NestInFileClass* value) {
  return ::google::protobuf::internal::ParseNamedEnum<JavaFeatures_NestInFileClass>(
      JavaFeatures_NestInFileClass_descriptor(), name, value);
}
...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures) */ {
 ...
 public:
  ...
  static constexpr NestInFileClass NEST_IN_FILE_CLASS_UNKNOWN = JavaFeatures_NestInFileClass_NEST_IN_FILE_CLASS_UNKNOWN;
  ...
  static constexpr NestInFileClass NestInFileClass_MIN = JavaFeatures_NestInFileClass_NestInFileClass_MIN;
  static constexpr NestInFileClass NestInFileClass_MAX = JavaFeatures_NestInFileClass_NestInFileClass_MAX;
  static constexpr int NestInFileClass_ARRAYSIZE = JavaFeatures_NestInFileClass_NestInFileClass_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor* NestInFileClass_descriptor() {
  ...
  static inline bool NestInFileClass_Parse(absl::string_view name, NestInFileClass* value) {
  ...
  void _internal_set_nest_in_file_class(::pb::JavaFeatures_NestInFileClass value);
...
inline ::pb::JavaFeatures_NestInFileClass JavaFeatures::nest_in_file_class() const {
  // @@protoc_insertion_point(field_get:pb.JavaFeatures.nest_in_file_class)
  return _internal_nest_in_file_class();
}
inline void JavaFeatures::set_nest_in_file_class(::pb::JavaFeatures_NestInFileClass value) {
  _internal_set_nest_in_file_class(value);
  _impl_._has_bits_[0] |= 0x00000008u;
  // @@protoc_insertion_point(field_set:pb.JavaFeatures.nest_in_file_class)
}
inline ::pb::JavaFeatures_NestInFileClass JavaFeatures::_internal_nest_in_file_class() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::pb::JavaFeatures_NestInFileClass>(_impl_.nest_in_file_class_);
}
inline void JavaFeatures::_internal_set_nest_in_file_class(::pb::JavaFeatures_NestInFileClass value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
template <>
inline const EnumDescriptor* GetEnumDescriptor<::pb::JavaFeatures_NestInFileClass>() {
