...
/* @@protoc_insertion_point(class_definition:pb.JavaFeatures.NestInFileClassFeature) */ {
 ...
 private:
  ...
  struct Helpers_ {
    ...
    static constexpr auto& SharedDtor = Super_::Helpers_::SharedDtor;
    static constexpr auto& InternalSwap = Super_::Helpers_::InternalSwap;
    static constexpr auto& MergeImpl = Super_::Helpers_::MergeImpl;
