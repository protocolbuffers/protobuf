...
PROTOBUF_EXPORT extern const uint32_t JavaFeatures_NestInFileClassFeature_NestInFileClass_internal_data_[];
enum JavaFeatures_Utf8Validation : int;
PROTOBUF_EXPORT extern const uint32_t JavaFeatures_Utf8Validation_internal_data_[];
class JavaFeatures;
struct JavaFeaturesDefaultTypeInternal;
PROTOBUF_EXPORT extern JavaFeaturesDefaultTypeInternal _JavaFeatures_default_instance_;
PROTOBUF_EXPORT extern const ::google::protobuf::internal::ClassDataFull JavaFeatures_class_data_;
class JavaFeatures_NestInFileClassFeature;
struct JavaFeatures_NestInFileClassFeatureDefaultTypeInternal;
PROTOBUF_EXPORT extern JavaFeatures_NestInFileClassFeatureDefaultTypeInternal _JavaFeatures_NestInFileClassFeature_default_instance_;
PROTOBUF_EXPORT extern const ::google::protobuf::internal::ClassDataFull JavaFeatures_NestInFileClassFeature_class_data_;
}  // namespace pb
namespace google {
namespace protobuf {
