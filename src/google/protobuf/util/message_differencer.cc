...
bool MessageDifferencer::ShouldCompareNoPresence(
  ...
  const bool compare_no_presence_by_address =
      ...
      require_no_presence_addresses_.addresses.contains(
          TextFormat::Parser::UnsetFieldsMetadata::
              ExplicitlyUnsetProtoFieldAddress(message1, reflection1, *field2));
  return compare_no_presence_by_field || compare_no_presence_by_address;
}
