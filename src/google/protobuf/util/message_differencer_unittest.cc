...
class UnsetFieldsMetadataTestUtil {
 public:
  static void AddExplicitUnsetField(
    ...
    metadata->addresses.insert(
        TextFormat::Parser::UnsetFieldsMetadata::
            ExplicitlyUnsetProtoFieldAddress(message, reflection, fd));
  }
};
}  // namespace text_format_unittest_util
...
using text_format_unittest_util::UnsetFieldsMetadataTestUtil;
...
TEST(MessageDifferencerTest,
  ...
  TextFormat::Parser::UnsetFieldsMetadata metadata;
  UnsetFieldsMetadataTestUtil::AddExplicitUnsetField(msg1, *reflection1, *fd1,
                                                     &metadata);
  address_differencer.set_require_no_presence_addresses(metadata);
...
TEST(MessageDifferencerTest,
  ...
  const FieldDescriptor* fd1 = msg1.GetDescriptor()->FindFieldByNumber(1);
  TextFormat::Parser::UnsetFieldsMetadata metadata;
  UnsetFieldsMetadataTestUtil::AddExplicitUnsetField(
