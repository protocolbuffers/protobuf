...
PROTOBUF_EXPORT ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
    scc_info_Empty_google_2fprotobuf_2fempty_2eproto = {
        {ATOMIC_VAR_INIT(
         ...
         0, 0, InitDefaultsscc_info_Empty_google_2fprotobuf_2fempty_2eproto},
        {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_google_2fprotobuf_2fempty_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u, // no _has_bits_
            PROTOBUF_FIELD_OFFSET(PROTOBUF_NAMESPACE_ID::Empty,
                                  _internal_metadata_),
            ~0u, // no _extensions_
            ~0u, // no _oneof_case_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    *const descriptor_table_google_2fprotobuf_2fempty_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase
    *const descriptor_table_google_2fprotobuf_2fempty_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_google_2fprotobuf_2fempty_2eproto = {
        &descriptor_table_google_2fprotobuf_2fempty_2eproto_initialized,
        descriptor_table_protodef_google_2fprotobuf_2fempty_2eproto,
        "google/protobuf/empty.proto",
        183,
        &descriptor_table_google_2fprotobuf_2fempty_2eproto_once,
        descriptor_table_google_2fprotobuf_2fempty_2eproto_sccs,
...
Empty::Empty(::PROTOBUF_NAMESPACE_ID::Arena *arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(arena) {
  SharedCtor();
...
void Empty::SharedDtor() { GOOGLE_DCHECK(GetArenaNoVirtual() == nullptr); }
...
const char *
Empty::_InternalParse(const char *ptr,
...
PROTOBUF_NAMESPACE_OPEN
template <>
PROTOBUF_NOINLINE PROTOBUF_NAMESPACE_ID::Empty *
