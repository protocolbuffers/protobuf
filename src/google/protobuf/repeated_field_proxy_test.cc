...
class RepeatedStringFieldProxyTest
 ...
 protected:
  ...
  template <typename T>
  static constexpr void VerifyLambdaTypeRequirements(T&& lambda_argument) {
...
TYPED_TEST(RepeatedNumericFieldProxyTest, Limits) {
  using ElementType = typename TypeParam::value_type::ElementType;
...
TEST_P(RepeatedFieldProxyTest, ResizeCordWithCordValue) {
  auto field = MakeRepeatedFieldContainer<absl::Cord>();
  field->Add(absl::Cord("1"));

  auto proxy = field.MakeProxy();
  proxy.resize(3, absl::Cord("10"));
...
TYPED_TEST(RepeatedNumericFieldProxyTest, CSort) {
  ...
  google::protobuf::c_sort(proxy, [this, &field](auto&& lhs, auto&& rhs) {
    this->VerifyLambdaTypeRequirements(field, std::forward<decltype(lhs)>(lhs));
    this->VerifyLambdaTypeRequirements(field, std::forward<decltype(rhs)>(rhs));
...
TEST(RepeatedFieldProxyInterfaceTest, RepeatedMessageProxy) {
  ...
  {
    google::protobuf::RepeatedFieldProxy<TestRepeatedMessageProxy::NestedMessage> proxy =
        msg.mutable_nested_messages_proxy();
    proxy.emplace_back().set_value(1);
    proxy.emplace_back().set_value(2);
    proxy.emplace_back().set_value(3);
  }

  google::protobuf::RepeatedFieldProxy<const TestRepeatedMessageProxy::NestedMessage>
      proxy = msg.nested_messages_proxy();
  EXPECT_THAT(proxy, ElementsAre(EqualsProto(R"pb(value: 1)pb"),
                                 EqualsProto(R"pb(value: 2)pb"),
                                 EqualsProto(R"pb(value: 3)pb")));
}
...
TEST(RepeatedFieldProxyInterfaceTest, RepeatedImportMessageProxy) {
  ...
  {
    google::protobuf::RepeatedFieldProxy<RepeatedFieldProxyTestImportMessage> proxy =
        msg.mutable_import_messages_proxy();
    proxy.emplace_back().set_value(1);
    proxy.emplace_back().set_value(2);
    proxy.emplace_back().set_value(3);
  }

  google::protobuf::RepeatedFieldProxy<const RepeatedFieldProxyTestImportMessage> proxy =
      msg.import_messages_proxy();
  EXPECT_THAT(proxy, ElementsAre(EqualsProto(R"pb(value: 1)pb"),
                                 EqualsProto(R"pb(value: 2)pb"),
                                 EqualsProto(R"pb(value: 3)pb")));
}
...
TEST(RepeatedFieldProxyInterfaceTest, RepeatedCordProxy) {
  ...
  {
    google::protobuf::RepeatedFieldProxy<absl::Cord> proxy = msg.mutable_cords_proxy();
    proxy.emplace_back("1");
    proxy.emplace_back("2");
    proxy.emplace_back("3");
  }

  google::protobuf::RepeatedFieldProxy<const absl::Cord> proxy = msg.cords_proxy();
  EXPECT_THAT(proxy, ElementsAre("1", "2", "3"));
}
