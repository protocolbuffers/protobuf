...
#if defined(PROTOBUF_CUSTOM_VTABLE)
PROTOBUF_NOINLINE void CppFileOptions::ClearImpl(MessageLite& base) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL CppFileOptions::_InternalSerializeImpl(
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t CppFileOptions::ByteSizeLongImpl(const MessageLite& base) {
  const CppFileOptions& this_ = static_cast<const CppFileOptions&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
