...
void CppFileOptions::Clear(MessageLite& base) {
...
#if !defined(PROTOBUF_CUSTOM_VTABLE)
PROTOBUF_NOINLINE void CppFileOptions::Clear() { Clear(*this); }
#endif  // PROTOBUF_CUSTOM_VTABLE
...
#if !defined(PROTOBUF_CUSTOM_VTABLE)
::size_t CppFileOptions::ByteSizeLong() const { return ByteSizeLong(*this); }
#endif  // !PROTOBUF_CUSTOM_VTABLE
