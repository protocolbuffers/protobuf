...
#if defined(PROTOBUF_CUSTOM_VTABLE)
PROTOBUF_NOINLINE void JsonEnumValueOptions::ClearImpl(MessageLite& base) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL JsonEnumValueOptions::_InternalSerializeImpl(
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t JsonEnumValueOptions::ByteSizeLongImpl(const MessageLite& base) {
  const JsonEnumValueOptions& this_ = static_cast<const JsonEnumValueOptions&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
