...
/* @@protoc_insertion_point(class_definition:pb.file.CppFileOptions) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void CopyFrom(const CppFileOptions& from) {
    CppFileOptions::Helpers_::CopyImpl(*this, from);
  }
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const CppFileOptions& from) {
    CppFileOptions::Helpers_::MergeImpl(*this, from);
  }
