...
constexpr ListValue::ParseTableT_ ListValue::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    ...
    {{
        ...
        {::_pbi::FieldAuxClassData(), &::google::protobuf::Value_class_data_},
        #else
...
constexpr Value::ParseTableT_ Value::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    ...
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::FieldAuxClassData(), &::google::protobuf::Struct_class_data_},
        #else
        {::_pbi::FieldAuxClassData(), &::google::protobuf::Struct_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::FieldAuxClassData(), &::google::protobuf::ListValue_class_data_},
        #else
  ...
  switch (kind_case()) {
    case KIND_NOT_SET:
      ...
      case kBoolValue:
        ...
        break;
      case kStructValue:
        _impl_.kind_.struct_value_ = Super_::CopyConstruct(arena, *from._impl_.kind_.struct_value_);
        break;
      case kListValue:
        _impl_.kind_.list_value_ = Super_::CopyConstruct(arena, *from._impl_.kind_.list_value_);
        break;
  }
