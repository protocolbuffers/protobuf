...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT MapKey {
 public:
  MapKey() = default;
...
// the map value.
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT MapValueConstRef {
 public:
...
// the map value.
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT MapValueRef final
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT
    ConstMapIterator final : public MapIteratorBase</*kIsMutable=*/false> {
  friend class internal::MapFieldBase;
  template <typename MessageT>
...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED PROTOBUF_EXPORT MapIterator final
