...
void DescriptorBuilder::ValidateNamingStyle(const FileDescriptor* file,
  ...
  if (const absl::Status s = IsValidLowerSnakeCaseName(file->package());
      !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(const Descriptor* message,
                                            const DescriptorProto& proto) {
  if (const absl::Status s = IsValidTitleCaseName(message->name()); !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(const OneofDescriptor* oneof,
                                            const OneofDescriptorProto& proto) {
  if (const absl::Status s = IsValidLowerSnakeCaseName(oneof->name());
      !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(const FieldDescriptor* field,
                                            const FieldDescriptorProto& proto) {
  if (const absl::Status s = IsValidLowerSnakeCaseName(field->name());
      !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(
  ...
  if (const absl::Status s = IsValidTitleCaseName(enum_descriptor->name());
      !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(
    const EnumValueDescriptor* enum_value,
    const EnumValueDescriptorProto& proto) {
  if (const absl::Status s = IsValidUpperSnakeCaseName(enum_value->name());
      !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(
  ...
  if (const absl::Status s = IsValidTitleCaseName(service->name()); !s.ok()) {
...
void DescriptorBuilder::ValidateNamingStyle(
  ...
  if (const absl::Status s = IsValidTitleCaseName(method->name()); !s.ok()) {
