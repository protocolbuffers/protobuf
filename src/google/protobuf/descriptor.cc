...
Symbol DescriptorPool::Tables::FindByNameHelper(const DescriptorPool* pool,
  ...
  if (pool->mutex_ != nullptr) {
    ...
    PROTOBUF_READER_MUTEX_LOCK(lock, *pool->mutex_);
...
FileDescriptorTables::FindEnumValueByNumberCreatingIfUnknown(
  ...
  {
    PROTOBUF_READER_MUTEX_LOCK(l, unknown_enum_values_mu_);
  ...
  // necessary.
  {
    PROTOBUF_WRITER_MUTEX_LOCK(l, unknown_enum_values_mu_);
    auto it = unknown_enum_values_by_number_.find(query);
    if (it != unknown_enum_values_by_number_.end()) {
      return *it;
    }
...
const FieldDescriptor* DescriptorPool::FindExtensionByNumber(
  ...
  if (mutex_ != nullptr) {
    PROTOBUF_READER_MUTEX_LOCK(lock, *mutex_);
