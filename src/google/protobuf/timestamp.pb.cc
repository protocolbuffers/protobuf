...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_google_2fprotobuf_2ftimestamp_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u, // no _has_bits_
            PROTOBUF_FIELD_OFFSET(PROTOBUF_NAMESPACE_ID::Timestamp,
                                  _internal_metadata_),
            ~0u, // no _extensions_
            ~0u, // no _oneof_case_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    *const descriptor_table_google_2fprotobuf_2ftimestamp_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase
    *const descriptor_table_google_2fprotobuf_2ftimestamp_2eproto_sccs[1] = {
...
void Timestamp::SharedDtor() { GOOGLE_DCHECK(GetArenaNoVirtual() == nullptr); }
...
void Timestamp::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void Timestamp::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message &from) {
  ...
  const Timestamp *source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Timestamp>(&from);
  if (source == nullptr) {
...
bool Timestamp::IsInitialized() const { return true; }
