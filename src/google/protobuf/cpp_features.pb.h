...
inline bool CppFeatures_StringType_Parse(absl::string_view name,
                             CppFeatures_StringType* PROTOBUF_NONNULL value) {
...
/* @@protoc_insertion_point(class_definition:pb.CppFeatures) */ {
 ...
 public:
  ...
  static inline bool StringType_Parse(absl::string_view name,
                                  StringType* PROTOBUF_NONNULL value) {
...
GetEnumDescriptor<::pb::CppFeatures_StringType>() {
