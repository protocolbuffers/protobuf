...
// However, it has mutable fields for lazy initialization of reflection related
// data. To keep the lazy initialization and to move the ClassData to the
// read-only section we use a secondary table. Extra indirection should be
// tolerable considering that reflection isn't performance critical.
