...
class PROTOBUF_EXPORT  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED
    Duration final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.Duration) */ {
 public:
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD static const Duration&
  default_instance() {
  ...
  PROTOBUF_FUTURE_ADD_EARLY_NODISCARD Duration* PROTOBUF_NONNULL
