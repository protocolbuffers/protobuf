...
PROTOBUF_NAMESPACE_OPEN
template <>
PROTOBUF_EXPORT PROTOBUF_NAMESPACE_ID::Duration *
Arena::CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Duration>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
PROTOBUF_NAMESPACE_OPEN

// ===================================================================

class PROTOBUF_EXPORT Duration : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Duration)
                                                                          */
{
public:
  Duration();
...
// int64 seconds = 1;
inline void Duration::clear_seconds() { seconds_ = PROTOBUF_LONGLONG(0); }
...
inline void
Duration::_internal_set_seconds(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void
Duration::_internal_set_nanos(::PROTOBUF_NAMESPACE_ID::int32 value) {
