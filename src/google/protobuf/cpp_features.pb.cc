...
inline PROTOBUF_NDEBUG_INLINE CppFeatures::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena, const Impl_& rhs)
      : _has_bits_{rhs._has_bits_},
        _cached_size_{} {}

inline PROTOBUF_NDEBUG_INLINE CppFeatures::Impl_::~Impl_() = default;
...
#ifdef PROTOBUF_NEW_CONSTRUCTORS
CppFeatures::CppFeatures(::google::protobuf::Arena* arena)
    : ::google::protobuf::Message(arena) , _impl_(internal_visibility(), arena) {
...
CppFeatures::CppFeatures(::google::protobuf::Arena* arena,
    ...
    : ::google::protobuf::Message(arena) , _impl_(internal_visibility(), arena, rhs._impl_) {
...
template<> PROTOBUF_NOINLINE ::pb::CppFeatures*
Arena::CreateMaybeMessage<::pb::CppFeatures>(Arena* arena, const ::pb::CppFeatures& rhs) {
  return Arena::CreateMessageInternal< ::pb::CppFeatures >(arena, rhs);
}
}  // namespace protobuf
}  // namespace google
