...
inline void* PROTOBUF_NONNULL CppFeatures::Helpers_::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) CppFeatures(arena);
}
constexpr auto CppFeatures::Helpers_::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(CppFeatures), alignof(CppFeatures));
}
constexpr auto CppFeatures::Helpers_::InternalGenerateClassData_() {
...
struct CppFeaturesGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr CppFeaturesGlobalsTypeInternal()
      : MessageGlobalsBase(
            CppFeatures::Helpers_::InternalGenerateClassData_()),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(CppFeatures::_Internal::GenerateParseTable(GetClassData())) {}
  ~CppFeaturesGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) CppFeatures _default;
  };
  decltype(CppFeatures::_Internal::GenerateParseTable(
