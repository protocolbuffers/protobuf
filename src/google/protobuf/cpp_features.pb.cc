...
const ::_pbi::TcParseTable<2, 3, 1, 0, 2> CppFeatures::_table_ = {
  ...
  if (cached_has_bits & 0x00000007u) {
    ::memset(&this_._impl_.string_type_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&this_._impl_.enum_name_uses_string_view_) -
        reinterpret_cast<char*>(&this_._impl_.string_type_)) + sizeof(this_._impl_.enum_name_uses_string_view_));
  }
