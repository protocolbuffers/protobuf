...
TEST_F(FeaturesTest, FieldCppRepeatedType) {
  ...
  EXPECT_EQ(repeated_message->cpp_repeated_type(),
            FieldDescriptor::CppRepeatedType::kRepeated);
  EXPECT_EQ(repeated_message_proxy->cpp_repeated_type(),
            FieldDescriptor::CppRepeatedType::kProxy);
  EXPECT_EQ(repeated_int32->cpp_repeated_type(),
            FieldDescriptor::CppRepeatedType::kRepeated);
  EXPECT_EQ(repeated_int32_proxy->cpp_repeated_type(),
            FieldDescriptor::CppRepeatedType::kProxy);
}
