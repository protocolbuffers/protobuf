...
FileDescriptorProto MakeFile(absl::string_view in) {
  FileDescriptorProto proto;
...
TEST_F(DescriptorTest, AllSymbolNamesHaveLengthLimits) {
  ...
  TestBuildFileOnNameLimits(proto, proto.mutable_package(), limits.package_name,
  ...
  TestBuildFileOnNameLimits(
      ...
      limits.reserved_name, "Reserved name too long");
