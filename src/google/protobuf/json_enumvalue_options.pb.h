...
/* @@protoc_insertion_point(class_definition:pb.enumvalue.JsonEnumValueOptions) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void CopyFrom(const JsonEnumValueOptions& from) {
    JsonEnumValueOptions::Helpers_::CopyImpl(*this, from);
  }
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const JsonEnumValueOptions& from) {
    JsonEnumValueOptions::Helpers_::MergeImpl(*this, from);
  }
