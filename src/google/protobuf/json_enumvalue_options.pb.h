...
/* @@protoc_insertion_point(class_definition:pb.enumvalue.JsonEnumValueOptions) */ {
 ...
 public:
  ...
  PROTOBUF_ALWAYS_INLINE_NODEBUG void MergeFrom(const JsonEnumValueOptions& from) {
    JsonEnumValueOptions::_Helpers::MergeImpl(*this, from);
  }
 ...
 private:
  ...
  struct _Helpers {
    ...
    static constexpr JsonEnumValueOptions::ParseTableT_ InternalGenerateParseTable_(
  ...
  friend JsonEnumValueOptionsGlobalsTypeInternal;
  template <typename T>
