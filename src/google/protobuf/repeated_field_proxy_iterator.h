...
template <typename ElementType, bool Reverse>
class RepeatedFieldProxyIteratorImpl {
  // An alias for self.
  using iterator = RepeatedFieldProxyIteratorImpl<ElementType, Reverse>;
 ...
 public:
  ...
  RepeatedFieldProxyIteratorImpl(
      const RepeatedFieldProxyIteratorImpl<std::remove_const_t<E>, Reverse>&
          other)
      : it_(other.it_) {}

  // Allow explicit conversion from forward to reverse iterators.
  template <bool R = Reverse, typename = std::enable_if_t<R>>
...
class RepeatedFieldProxyIteratorInternalPrivateAccessHelper {
 ...
 public:
  ...
  static Traits::type::iterator iterator(
      const RepeatedFieldProxyIteratorImpl<ElementType, Reverse>& it) {
    return it.it_;
  }
};
...
using RepeatedFieldProxyIterator =
    RepeatedFieldProxyIteratorImpl<ElementType, /*Reverse=*/false>;
template <typename ElementType>
using RepeatedFieldProxyReverseIterator =
    RepeatedFieldProxyIteratorImpl<ElementType, /*Reverse=*/true>;
