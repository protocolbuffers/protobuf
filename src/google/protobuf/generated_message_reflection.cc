...
void AddDescriptorsImpl(const DescriptorTable* table) {
  ...
  // have to either avoid registering these pre-main or do it in reflection code
  // like this, because we need to ensure that the linker --gc-sections step can
  // strip out the full runtime if it is unused.
