...
void WriteModelPublicDeclaration(
  ...
  output(
      R"cc(
        private:
        const upb_Message* msg() const { return (const upb_Message*)msg_; }
        upb_Message* msg() { return (upb_Message*)msg_; }
...
void WriteModelProxyDeclaration(const protobuf::Descriptor* descriptor,
  ...
  output(
      R"cc(
        private:
        upb_Message* msg() const { return (upb_Message*)msg_; }
    ...
    output(
        R"cc(
          ...
          $0::$0(const $0& from) : $0Access() {
            arena_ = owned_arena_.ptr();
            msg_ = ($1*)::protos::internal::DeepClone((upb_Message*)from.msg_,
                                                      &$2, arena_);
          }
          $0::$0(const CProxy& from) : $0Access() {
            arena_ = owned_arena_.ptr();
            msg_ = ($1*)::protos::internal::DeepClone(
                (upb_Message*)::protos::internal::GetInternalMsg(&from), &$2,
                arena_);
          }
