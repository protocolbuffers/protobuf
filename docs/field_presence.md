...
[protobuf editions](https://protobuf.dev/editions/overview/), field presence
behavior is controlled by the
[`field_presence` feature](https://protobuf.dev/editions/features/#field_presence).
Prior to this, proto2 has mostly followed *explicit presence*, while proto3
...
label have *explicit presence*, like proto2.
...
### Presence when `features.field_presence = EXPLICIT`

This table outlines whether presence is tracked for fields using
`features.field_presence = EXPLICIT`, (including proto2 files). This table
applies to both generated APIs and using dynamic reflection:
...
### Presence when `features.field_presence = IMPLICIT`

This table outlines whether presence is tracked for fields using
`features.field_presence = IMPLICIT` (including proto3 files). This table
applies to both generated APIs and using dynamic reflection:
