...
// server to ensure at runtime the code generated sources were compiled with
// are also the versions linked/loaded. The values are only removed when
// GOOGLE_PROTOBUF_OBJC_MIN_SUPPORTED_VERSION is also raised.
extern int32_t GOOGLE_PROTOBUF_OBJC_EXPECTED_GENCODE_VERSION_30008;  // NOLINT
