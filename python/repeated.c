...
upb_Array* PyUpb_RepeatedContainer_Reify(PyObject* _self, upb_Array* arr,
  ...
  PyUpb_WeakMap_Add(PyUpb_Arena_GetCache(self->arena), arr, &tmp_ret);
...
static void PyUpb_RepeatedContainer_Dealloc(PyObject* _self) {
  ...
  if (PyUpb_RepeatedContainer_IsStub(self)) {
    ...
    PyUpb_WeakMap_Delete(PyUpb_Arena_GetCache(self->arena), self->ptr.arr);
  }
...
PyObject* PyUpb_RepeatedContainer_GetOrCreateWrapper(upb_Array* arr,
                                                     const upb_FieldDef* f,
                                                     PyObject* arena) {
  PyObject* ret = PyUpb_WeakMap_Get(PyUpb_Arena_GetCache(arena), arr);
  if (ret) return ret;
  ...
  Py_INCREF(arena);
  PyUpb_WeakMap_Add(PyUpb_Arena_GetCache(arena), arr, &ret);
  return ret;
}
...
PyObject* PyUpb_RepeatedContainer_DeepCopy(PyObject* _self, PyObject* value) {
  ...
  PyUpb_WeakMap_Add(PyUpb_Arena_GetCache(clone->arena), clone->ptr.arr,
                    &tmp_clone);
