...
PyObject* pymessage_get(PyObject* self, PyObject* args) {
  // TODO: Remove this hack in OSS when ODR vidlations
  // if fixed.
  // TestAllTypes is not linked into generated_pool or there's two
  // generated_pool (due to ODR violations) without this hack. This
