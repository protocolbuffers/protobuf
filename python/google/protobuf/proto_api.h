...
struct PyProto_API {
  ...
  //
  // This function helps to ensure that the dependency outlives the python
  // descriptor pool.
  // This may be useful to ensure that the C++ descriptor pool does
  // not get deleted before the provided python representative does.
  virtual bool AddCachedPoolDependency(PyObject* py_pool,
                                       PyObject* py_dependency) const = 0;
