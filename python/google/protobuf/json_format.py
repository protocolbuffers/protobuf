  ...
  def _GetEnumValueJsonExtension(self):
    if self._enumvalue_json_extension is None:
      ...
      try:
        ...
        # _enumvalue_json_extension. Over the longer term, we can consider
        # putting this information in bootstrap files so that we don't have to
        # rely on using reflection to perform this lookup at all.
