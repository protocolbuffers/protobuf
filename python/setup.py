...
class build_py(_build_py):
    ...
    # "Approach 2" section on how to get 2to3 to run on source files
    # during install under Python 3.  This class seems like a good place
    # to put logic that calls python3's distutils.util.run_2to3 on
    # the subset of the files we have in our release that are
...
if __name__ == '__main__':
    ...
    setup(
        ...
        # TODO: Restore dependency once a Python 3 compatible
        # google-apputils is released.
        setup_requires=['google-apputils'] if not PY3 else [],
        ...
        long_description="Protocol Buffers are Google's "
