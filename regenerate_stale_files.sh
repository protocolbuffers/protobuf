...
${BazelBin} test upb/reflection:descriptor_upb_proto_upb_stage1_staleness_test "$@" || ./bazel-bin/upb/reflection/descriptor_upb_proto_upb_stage1_staleness_test --fix
${BazelBin} test upb/reflection:descriptor_upb_proto_upb_minitable_stage1_staleness_test "$@" || ./bazel-bin/upb/reflection/descriptor_upb_proto_upb_minitable_stage1_staleness_test --fix
${BazelBin} test upb_generator:plugin_upb_proto_upb_stage1_staleness_test "$@" || ./bazel-bin/upb_generator/plugin_upb_proto_upb_stage1_staleness_test --fix
${BazelBin} test upb_generator:plugin_upb_proto_upb_minitable_stage1_staleness_test "$@" || ./bazel-bin/upb_generator/plugin_upb_proto_upb_minitable_stage1_staleness_test --fix
