...
""",
    ...
    attrs = {
        "out": attr.output(
            doc = "The generated filename (example: `file_lists.cmake`).",
            mandatory = True,
        ),
        "src_libs": attr.label_keyed_string_dict(
            doc = (
                "Libraries to include. These can be C++ rules (like " +
                "`cc_library` or `cc_test`) or `proto_library` rules. " +
                "The key is the target, and the value is the `libname`."
            ),
            mandatory = True,
            providers = [[CcFileList], [ProtoFileList]],
...
""",
    ...
    attrs = {
        "out": attr.output(
            doc = "The generated filename (example: `file_lists.am`).",
            mandatory = True,
        ),
        "src_libs": attr.label_keyed_string_dict(
            doc = (
