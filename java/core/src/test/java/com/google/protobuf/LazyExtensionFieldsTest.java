...
/** Tests for lazy extension fields with validations. */
...
public final class LazyExtensionFieldsTest {
  ...
  //   TestAllExtensions proto = TestAllExtensions.parser().parsePartialFrom(data,
  // extensionRegistry);
  ...
  // @Test
  // public void invalidVarintInNestedMessage() throws Exception {
  //   byte[] nestedFieldData =
  //       createFieldData(
  //           1,
  //           WireFormat.WIRETYPE_VARINT,
  //           bytes(0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00));
  //   byte[] nestedData = createFieldData(18, WireFormat.WIRETYPE_LENGTH_DELIMITED,
  // nestedFieldData);
  ...
  //   InvalidProtocolBufferException throwable =
  //       assertThrows(
  //           InvalidProtocolBufferException.class, () -> proto.mergeFrom(data,
  // extensionRegistry));
  ...
  // @Test
  // public void invalidVarintInNestedGroup() throws Exception {
  //   byte[] fieldData =
  //       createFieldData(
  //           17,
  //           WireFormat.WIRETYPE_VARINT,
  ...
  //   byte[] data = createFieldData(1002, WireFormat.WIRETYPE_LENGTH_DELIMITED,
  // recursiveMessageData);
  //   TestParsingMerge.Builder proto = TestParsingMerge.newBuilder();
