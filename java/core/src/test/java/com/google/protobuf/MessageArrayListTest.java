...
/** Tests for {@link MessageArrayList}. */
public class MessageArrayListTest extends TestCase {

  private static final MessageArrayList<Integer> UNARY_LIST = newImmutableProtoArrayList(1);
  private static final MessageArrayList<Integer> TERTIARY_LIST =
      newImmutableProtoArrayList(1, 2, 3);

  private MessageArrayList<Integer> list;

  @Override
  protected void setUp() throws Exception {
    list = new MessageArrayList<Integer>();
  }

  public void testEmptyListReturnsSameInstance() {
    assertSame(MessageArrayList.emptyList(), MessageArrayList.emptyList());
  }

  public void testEmptyListIsImmutable() {
    assertImmutable(MessageArrayList.<Integer>emptyList());
  }
  ...
  public void testSize() {
    assertEquals(0, MessageArrayList.emptyList().size());
  ...
  private void assertImmutable(List<Integer> list) {
    ...
    try {
      list.addAll(new MessageArrayList<Integer>());
      fail();
    } catch (UnsupportedOperationException e) {
      // expected
    }
  ...
  private static MessageArrayList<Integer> newImmutableProtoArrayList(int... elements) {
    MessageArrayList<Integer> list = new MessageArrayList<Integer>();
