...
public final class MapFieldLite<K, V> extends AbstractMap<K, V> {
  ...
  private MapFieldLite(Map<K, V> mapData) {
    this.delegate = new LinkedHashMap<>(mapData);
    this.isMutable = true;
  }
  ...
  public Set<Map.Entry<K, V>> entrySet() {
    ...
    return new MutabilityAwareSet<>(delegate.entrySet());
  }
  ...
  private class MutabilityAwareSet<E> extends AbstractSet<E> {
    private final Set<E> delegateSet;

    MutabilityAwareSet(Set<E> delegateSet) {
      this.delegateSet = delegateSet;
    }

    @Override
    public Iterator<E> iterator() {
      return new MutabilityAwareIterator<>(delegateSet.iterator());
    }
  ...
  private class MutabilityAwareIterator<E> implements Iterator<E> {
    private final Iterator<E> delegateIterator;

    MutabilityAwareIterator(Iterator<E> delegateIterator) {
