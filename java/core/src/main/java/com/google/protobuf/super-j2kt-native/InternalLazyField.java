 ...
 * be null.
 */
@SuppressWarnings({"PatternMatchingInstanceof", "nullness"})
class InternalLazyField {
  ...
  protected volatile @Nullable MessageLite value;
   ...
   */
  static class LazyEntry<K> implements Entry<K, @Nullable Object> {
