  ...
  public static final class Field {
    ...
    public static final class Builder {
      ...
      public Builder addVarint(long value) {
        ...
        if (!result.varint.isModifiable()) {
          // TODO: grow it exponentially.
          result.varint = result.varint.mutableCopyWithCapacity(result.varint.size());
        }
      ...
      public Builder addFixed32(int value) {
        ...
        if (!result.fixed32.isModifiable()) {
          // TODO: grow it exponentially.
          result.fixed32 = result.fixed32.mutableCopyWithCapacity(result.fixed32.size());
        }
      ...
      public Builder addFixed64(long value) {
        ...
        if (!result.fixed64.isModifiable()) {
          // TODO: grow it exponentially.
          result.fixed64 = result.fixed64.mutableCopyWithCapacity(result.fixed64.size());
        }
