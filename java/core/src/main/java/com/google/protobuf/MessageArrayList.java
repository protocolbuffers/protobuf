...
/** Implements {@link MessageList} for repeated messages. */
final class MessageArrayList<E> extends AbstractProtobufList<E>
    implements MessageList<E>, RandomAccess {

  private static final Object[] EMPTY_ARRAY = new Object[0];

  private static final MessageArrayList<Object> EMPTY_LIST =
      new MessageArrayList<>(EMPTY_ARRAY, 0, false);

  @SuppressWarnings("unchecked") // Guaranteed safe by runtime.
  public static <E> MessageArrayList<E> emptyList() {
    return (MessageArrayList<E>) EMPTY_LIST;
  }
  ...
  private MessageArrayList(E[] array, int size, boolean isMutable) {
    super(isMutable);
    this.array = array;
    this.size = size;
  }
  ...
  @Override
  public MessageArrayList<E> mutableCopyWithCapacity(int capacity) {
    if (capacity < size) {
    ...
    return new MessageArrayList<E>(newArray, size, true);
  }
  ...
  public boolean equals(
    ...
    if (o instanceof MessageArrayList) {
      MessageArrayList<?> otherArray = (MessageArrayList<?>) o;
