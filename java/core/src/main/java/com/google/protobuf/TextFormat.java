...
public final class TextFormat {
   ...
   * Like {@code print()}, but writes directly to a {@code String} and returns it.
   *
   * @deprecated Use {@code printer().printToString(message,
   *     Printer.FieldReporterLevel.TEXTFORMAT_PRINT_TO_STRING)}
   */
  @Deprecated
  @InlineMe(
      replacement =
  ...
  @Deprecated
  @InlineMe(
      replacement = "TextFormat.printer().escapingNonAscii(false).printToString(message, output)",
      imports = "com.google.protobuf.TextFormat")
