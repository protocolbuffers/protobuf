...
public class RuntimeVersionLite {
  ...
  private static final Logger logger = Logger.getLogger(RuntimeVersionLite.class.getName());
  ...
  @SuppressWarnings("NonFinalStaticField")
  protected static String prevCheckedLocation = "";
