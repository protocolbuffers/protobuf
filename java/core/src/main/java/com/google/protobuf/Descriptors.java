  ...
  public static final class FileDescriptor extends GenericDescriptor {
    ...
    public static FileDescriptor buildFrom(
      ...
      if (!allowUnknownDependencies) {
        result.resolveFeaturesTransitive();
      }
      return result;
    }
    ...
    /** Resolve features for descriptor and its children */
    public void resolveFeaturesTransitive() {
      this.features = resolveFeatures(proto.getOptions().getFeatures());
      this.options = proto.getOptions();

      for (final Descriptor messageType : messageTypes) {
        messageType.resolveFeaturesTransitive();
      }

      for (final EnumDescriptor enumType : enumTypes) {
        enumType.resolveFeaturesTransitive();
      }

      for (final ServiceDescriptor service : services) {
        service.resolveFeaturesTransitive();
      }

      for (final FieldDescriptor extension : extensions) {
        extension.resolveFeaturesTransitive();
      }
    }
  ...
  public static final class Descriptor extends GenericDescriptor {
    ...
    public void resolveFeaturesTransitive() {
      ...
      for (final Descriptor nestedType : nestedTypes) {
        nestedType.resolveFeaturesTransitive();
      }
      ...
      for (final FieldDescriptor field : fields) {
        field.resolveFeaturesTransitive();
      }
      ...
      for (final OneofDescriptor oneof : oneofs) {
        oneof.resolveFeaturesTransitive();
      }
    }
  ...
  public static final class EnumDescriptor extends GenericDescriptor
    ...
    public void resolveFeaturesTransitive() {
      ...
      for (EnumValueDescriptor value : values) {
        value.resolveFeaturesTransitive();
      }
    }
  ...
  public static final class ServiceDescriptor extends GenericDescriptor {
    ...
    public void resolveFeaturesTransitive() {
      ...
      for (final MethodDescriptor method : methods) {
        method.resolveFeaturesTransitive();
      }
    }
