...
/**
 * These APIs are restricted to test-only targets, and are suitable for test assertion purposes
 * where it is impractical to compare protos directly via ProtoTruth (e.g. log output).
 */
