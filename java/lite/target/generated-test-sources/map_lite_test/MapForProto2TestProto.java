    ...
    public  static final class MessageValue extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case GET_PARSER: {
            com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.TestMap.MessageValue> parser = PARSER;
            if (parser == null) {
              synchronized (map_lite_test.MapForProto2TestProto.TestMap.MessageValue.class) {
                parser = PARSER;
                if (parser == null) {
                  parser =
                      new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.TestMap.MessageValue>(
                          DEFAULT_INSTANCE);
                  PARSER = parser;
                }
              }
    ...
    public  static final class MessageWithRequiredFields extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case GET_PARSER: {
            com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.TestMap.MessageWithRequiredFields> parser = PARSER;
            if (parser == null) {
              synchronized (map_lite_test.MapForProto2TestProto.TestMap.MessageWithRequiredFields.class) {
                parser = PARSER;
                if (parser == null) {
                  parser =
                      new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.TestMap.MessageWithRequiredFields>(
                          DEFAULT_INSTANCE);
                  PARSER = parser;
                }
              }
      ...
      switch (method) {
        ...
        case BUILD_MESSAGE_INFO: {
            java.lang.Object[] objects = new java.lang.Object[] {
              ...
              map_lite_test.MapForProto2TestProto.TestMap.EnumValue.internalGetVerifier(),
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.TestMap> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.TestMap.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.TestMap>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public  static final class TestUnknownEnumValue extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.TestUnknownEnumValue> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.TestUnknownEnumValue.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.TestUnknownEnumValue>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public  static final class TestRecursiveMap extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.TestRecursiveMap> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.TestRecursiveMap.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.TestRecursiveMap>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public  static final class BizarroTestMap extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.BizarroTestMap> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.BizarroTestMap.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.BizarroTestMap>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public  static final class ReservedAsMapField extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.ReservedAsMapField> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.ReservedAsMapField.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.ReservedAsMapField>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
      ...
      switch (method) {
        ...
        case BUILD_MESSAGE_INFO: {
            java.lang.Object[] objects = new java.lang.Object[] {
              "if_",
              IfDefaultEntryHolder.defaultEntry,
              map_lite_test.MapForProto2TestProto.ReservedAsMapFieldWithEnumValue.SampleEnum.internalGetVerifier(),
              "const_",
              ConstDefaultEntryHolder.defaultEntry,
              map_lite_test.MapForProto2TestProto.ReservedAsMapFieldWithEnumValue.SampleEnum.internalGetVerifier(),
              "private_",
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<map_lite_test.MapForProto2TestProto.ReservedAsMapFieldWithEnumValue> parser = PARSER;
          if (parser == null) {
            synchronized (map_lite_test.MapForProto2TestProto.ReservedAsMapFieldWithEnumValue.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<map_lite_test.MapForProto2TestProto.ReservedAsMapFieldWithEnumValue>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
