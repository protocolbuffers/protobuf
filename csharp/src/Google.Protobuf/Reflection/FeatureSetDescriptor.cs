...
{
    private const Edition MinSupportedEdition = Edition.Proto2;
    private const Edition MaxSupportedEdition = Edition._2023;
    ...
    private static IReadOnlyDictionary<Edition, FeatureSetDescriptor> BuildEditionDefaults()
    {
        ...
        var supportedEditions = ((Edition[]) Enum.GetValues(typeof(Edition)))
            .OrderBy(x => x)
            .Where(e => e >= MinSupportedEdition && e <= MaxSupportedEdition);
