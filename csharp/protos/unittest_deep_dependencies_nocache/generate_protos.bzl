...
def generate_nocache_protos(width, depth, package):
    """
...
def _generate_all_protos(name, width, depth, package, all_files):
    ...
    # Level 0 (base file) - just an empty file with the package
    cmd_parts.append("""
...
""")
    ...
    # Level 1 files - just import level 0
    for i in range(width):
        i_pad = _pad(i)
        cmd_parts.append("""
