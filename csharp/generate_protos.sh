...
# Proto files are generated by Bazel: bazel build //csharp/protos/unittest_deep_dependencies_cached:generate_all_protos
mkdir -p csharp/src/Google.Protobuf.Test.TestProtos/UnittestDeepDependenciesCached
$PROTOC --proto_path=src --proto_path=. --proto_path=bazel-bin/csharp/protos/unittest_deep_dependencies_cached \
    --experimental_allow_proto3_optional \
    --experimental_editions \
    --csharp_out=csharp/src/Google.Protobuf.Test.TestProtos/UnittestDeepDependenciesCached \
    --csharp_opt=file_extension=.pb.cs \
    $(find bazel-bin/csharp/protos/unittest_deep_dependencies_cached/unittest_deep_dependencies_cached -name "*.proto" -printf "unittest_deep_dependencies_cached/%f ")

# Deep dependencies test protos - Nocache version  
# Proto files are generated by Bazel: bazel build //csharp/protos/unittest_deep_dependencies_nocache:generate_all_protos
mkdir -p csharp/src/Google.Protobuf.Test.TestProtos/UnittestDeepDependenciesNocache
$PROTOC --proto_path=src --proto_path=. --proto_path=bazel-bin/csharp/protos/unittest_deep_dependencies_nocache \
    --experimental_allow_proto3_optional \
    --experimental_editions \
    --csharp_out=csharp/src/Google.Protobuf.Test.TestProtos/UnittestDeepDependenciesNocache \
    --csharp_opt=file_extension=.pb.cs \
    $(find bazel-bin/csharp/protos/unittest_deep_dependencies_nocache/unittest_deep_dependencies_nocache -name "*.proto" -printf "unittest_deep_dependencies_nocache/%f ")
