...
# ------------ test cases ---------------
  ...
  class MessageContainerTest < Test::Unit::TestCase
    ...
    def test_map_basic
      ...
      m["jkl;"] = 42
      assert_equal({ "jkl;" => 42, "asdf" => 1 }, m)
      assert_includes m, "asdf"
    ...
    def test_map_field
      m = MapMessage.new
      assert_empty m.map_string_int32
      assert_empty m.map_string_msg
      m = MapMessage.new(
      ...
      assert_equal({ "a" => TestMessage2.new(:foo => 1) }, m.map_string_msg)
      assert_raises TypeError do
    ...
    def test_reflection
      ...
      assert_instance_of TestMessage, msgdef.msgclass
