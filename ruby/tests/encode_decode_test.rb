...
class EncodeDecodeTest < Test::Unit::TestCase
  ...
  def test_encode_any
    test_any = A::B::C::TestAny.new();
    m = A::B::C::TestMessage.new(
        :optional_int32 => 1,
    )
    any1 = Google::Protobuf::Any.pack(m)
    any2 = Google::Protobuf::Any.pack(any1)
    test_any.any = any2
    puts test_any.to_json
    A::B::C::TestAny.decode_json(test_any.to_json)
  end
