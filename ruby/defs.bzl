...
load("//:protobuf.bzl", _internal_ruby_proto_library = "internal_ruby_proto_library", _internal_rbs_proto_library = "internal_rbs_proto_library")
...
def internal_rbs_proto_library(
        name,
        **kwargs):
    """Bazel rule to create an RBS type definirion for
    the Ruby protobuf library from proto source files
