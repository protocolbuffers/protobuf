    ...
    class Descriptor
      def build_message_class
        ...
        Class.new(Google::Protobuf::const_get(:AbstractMessage)) do
          ...
          def frozen?
            ruby_frozen = super
            upb_frozen = Google::Protobuf::FFI.message_frozen?(@msg)
            ...
            raise RuntimeError.new "Ruby frozen Message with mutable representation" if ruby_frozen
            false
          end
          ...
          def freeze
            ...
            unless Google::Protobuf::FFI.message_frozen?(@msg)
              raise RuntimeError.new "Underlying representation of message still mutable after freeze"
            end
            unless method(:frozen?).super_method.call
              raise RuntimeError.new "Ruby message still mutable after freeze"
            end
            self
          end
