...
if RUBY_PLATFORM =~ /mswin/
  # cl.exe does not understand GCC-style flags. -std:c11 is required for
  # _Generic, which the upb MSVC atomics fall back on.
  $CFLAGS += debug_enabled ? " -std:c11 -Od" : " -std:c11 -DNDEBUG"
