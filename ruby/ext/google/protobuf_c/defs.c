...
/*
 * call-seq:
 *     FieldDescriptor.is_required? => bool
 *
...
/*
 * call-seq:
 *     FieldDescriptor.is_repeated? => bool
 *
...
/*
 * DEPRECATED: Use is_repeated or is_required instead.
 *
 * call-seq:
...
static void FieldDescriptor_register(VALUE module) {
  ...
  rb_define_method(klass, "is_required", FieldDescriptor_is_required, 0);
  rb_define_method(klass, "is_repeated?", FieldDescriptor_is_repeated, 0);
