...
{
  if [ $1 == "php" ]; then
    tests=( array_test.php map_field_test.php generated_class_test.php encode_decode_test.php descriptors_test.php well_known_test.php )
  else
...
pushd ../../../../../src
./protoc --php_out=../php/ext/google/protobuf/hhvm/generated -I../php/ext/google/protobuf/hhvm -I. \
  ../php/ext/google/protobuf/hhvm/proto/test_import_descriptor_proto.proto
popd
