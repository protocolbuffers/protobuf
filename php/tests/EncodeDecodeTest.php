...
class EncodeDecodeTest extends TestBase
{
    ...
    public function testEnumDescriptorReflection() {
        ...
        $armorDesc = $pool->getEnumDescriptorByClassName(Armor::class);
        ...
        for ($i = 0; $i < $armorDesc->getValueCount(); $i++) {
            ...
            $armorValues[$valDesc->getName()] = $valDesc->getNumber();
        }
        $this->assertSame(0, $armorValues['ARMOR_UNKNOWN']);
        $this->assertSame(1, $armorValues['ARMOR_GREAT_HELM']);
        $this->assertSame(2, $armorValues['ARMOR_GORGET']);
        $this->assertSame(3, $armorValues['ARMOR_GAUNTLET']);
        $this->assertSame(4, $armorValues['ARMOR_PLATE']);
        $this->assertSame(5, $armorValues['ARMOR_COIF']);
        $this->assertSame(6, $armorValues['ARMOR_PAULDRON']);
        $this->assertSame(7, $armorValues['ARMOR_SABATON']);
        $this->assertSame(7, $armorValues['ARMOR_SOLLERET']);
        $this->assertSame(8, $armorValues['ARMOR_HACHI_MAI_DO']);
