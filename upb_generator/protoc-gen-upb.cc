  ...
  output(
      R"cc(
        ...
        UPB_INLINE $0* $0_parse(const char* buf, size_t size, upb_Arena* arena) {
          $0* ret = $0_new(arena);
          if (!ret) return NULL;
          if (upb_Decode(buf, size, (upb_Message*)ret, $1, NULL, 0, arena) !=
        ...
        UPB_INLINE $0* $0_parse_ex(const char* buf, size_t size,
          ...
          $0* ret = $0_new(arena);
          if (!ret) return NULL;
          if (upb_Decode(buf, size, (upb_Message*)ret, $1, extreg, options,
        ...
        UPB_INLINE char* $0_serialize(const $0* msg, upb_Arena* arena, size_t* len) {
          char* ptr;
          (void)upb_Encode((upb_Message*)msg, $1, 0, arena, &ptr, len);
          return ptr;
        }
        UPB_INLINE char* $0_serialize_ex(const $0* msg, int options,
                                         upb_Arena* arena, size_t* len) {
          char* ptr;
          (void)upb_Encode((upb_Message*)msg, $1, options, arena, &ptr, len);
          return ptr;
        }
      )cc",
  ...
  output(
      R"cc(
        UPB_INLINE size_t $0_$1_size(const $0* msg) {
          const upb_MiniTableField field = $2;
          const upb_Map* map = upb_Message_GetMap((upb_Message*)msg, &field);
  ...
  output(
      R"cc(
        UPB_INLINE const upb_Map* _$0_$1_$2($0* msg) {
          const upb_MiniTableField field = $4;
          return upb_Message_GetMap((upb_Message*)msg, &field);
        }
        UPB_INLINE upb_Map* _$0_$1_$3($0* msg, upb_Arena* a) {
          const upb_MiniTableField field = $4;
          return _upb_Message_GetOrCreateMutableMap((upb_Message*)msg, &field,
                                                    $5, $6, a);
        }
      )cc",
  ...
  output(
      R"cc(
        UPB_INLINE $0 $1_$2(const $1* msg) {
          ...
          $0 ret;
          const upb_MiniTableField field = $4;
          _upb_Message_GetNonExtensionField((upb_Message*)msg, &field,
                                            &default_val, &ret);
          return ret;
        }
      )cc",
  ...
  output(
      R"cc(
        UPB_INLINE void $0_$1_clear($0* msg) {
          const upb_MiniTableField field = $2;
          upb_Map* map = (upb_Map*)upb_Message_GetMap((upb_Message*)msg, &field);
          if (!map) return;
          _upb_Map_Clear(map);
        }
      )cc",
  ...
  output(
      R"cc(
        UPB_INLINE bool $0_$1_set($0* msg, $2 key, $3 val, upb_Arena* a) {
          const upb_MiniTableField field = $4;
          upb_Map* map = _upb_Message_GetOrCreateMutableMap((upb_Message*)msg,
                                                            &field, $5, $6, a);
  ...
  output(
      R"cc(
        UPB_INLINE $0* $1_resize_$2($1* msg, size_t size, upb_Arena* arena) {
          upb_MiniTableField field = $3;
          return ($0*)upb_Message_ResizeArrayUninitialized((upb_Message*)msg,
                                                           &field, size, arena);
        }
      )cc",
      CType(field), msg_name, resolved_name,
