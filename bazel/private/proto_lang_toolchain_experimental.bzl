"""A fork of proto_lang_toolchain that uses the "protoc_minimal" by default.

TODO b/305068148 - Remove this fork once "proto_compiler" is default to protoc_minimal.
"""
...
proto_lang_toolchain = rule(
    _rule_impl,
    doc = """
<p>A fork of proto_lang_toolchain that uses the "protoc_minimal" by default.
    """,
    attrs = {
