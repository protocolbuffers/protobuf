...
_incompatible_enable_proto_toolchain_resolution = False
...
def _toolchain_type(proto_lang_toolchain_info):
    if _incompatible_enable_proto_toolchain_resolution:
...
proto_common = struct(
    ...
    INCOMPATIBLE_ENABLE_PROTO_TOOLCHAIN_RESOLUTION = _incompatible_enable_proto_toolchain_resolution,
