...
def _test_link_order_with_mixed_deps_impl(env, target):
    ...
    action.inputs().contains_at_least_predicates([
        matching.file_path_matches("link_order_with_mixed_deps_foo"),
        matching.file_path_matches("link_order_with_mixed_deps_a"),
        matching.file_path_matches("link_order_with_mixed_deps_b"),
        ...
        matching.file_path_matches("link_order_with_mixed_deps_c"),
    ]).in_order()
...
def _test_link_order_with_mixed_deps_and_intermediate_library_impl(env, target):
    ...
    action.inputs().contains_at_least_predicates([
        matching.file_path_matches("link_order_with_mixed_deps_and_intermediate_library_foo"),
        matching.file_path_matches("link_order_with_mixed_deps_and_intermediate_library_lib"),
        matching.file_path_matches("link_order_with_mixed_deps_and_intermediate_library_a"),
        matching.file_path_matches("link_order_with_mixed_deps_and_intermediate_library_b"),
        # Using matching.any because the basename varies by platform in OSS.
        matching.any(
            matching.file_path_matches("protobuf/message"),
            matching.file_path_matches("protobuf/libprotobuf"),
        ),
        matching.file_path_matches("link_order_with_mixed_deps_and_intermediate_library_c"),
    ]).in_order()
...
def _test_link_order_with_mixed_deps_and_linkshared_impl(env, target):
    ...
    action.inputs().contains_at_least_predicates([
        matching.file_path_matches("link_order_with_mixed_deps_and_linkshared_foo"),
        matching.file_path_matches("link_order_with_mixed_deps_and_linkshared_a"),
        matching.file_path_matches("link_order_with_mixed_deps_and_linkshared_b"),
        # Using matching.any because the basename varies by platform in OSS.
        matching.any(
            matching.file_path_matches("protobuf/message"),
            matching.file_path_matches("protobuf/libprotobuf"),
        ),
        matching.file_path_matches("link_order_with_mixed_deps_and_linkshared_c"),
    ]).in_order()
