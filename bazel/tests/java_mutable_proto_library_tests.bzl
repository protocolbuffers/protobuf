...
def _test_mutable_binary_deps(name):
    util.helper_target(
        proto_library,
        name = name + "_baz_proto",
        srcs = ["baz.proto"],
    )
    util.helper_target(
        proto_library,
        name = name + "_foo_proto",
        srcs = [
            "bar.proto",
            "foo.proto",
        ],
        deps = [":" + name + "_baz_proto"],
    )
    util.helper_target(
        java_mutable_proto_library,
        name = name + "_java_mutable_proto",
        deps = [":" + name + "_foo_proto"],
    )
    analysis_test(
        name = name,
        target = ":" + name + "_java_mutable_proto",
...
def _test_mutable_binary_deps_impl(env, target):
    ...
    java_info.transitive_source_jars_in_package().contains_exactly([
        "{package}/test_mutable_binary_deps_foo_proto-new-mutable-src.jar",
        "{package}/test_mutable_binary_deps_baz_proto-new-mutable-src.jar",
    ])
    java_info.transitive_source_jars().contains_at_least([
        ...
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_impl-src.jar",
    ])

    # Should depend on Java libraries.
    java_info.transitive_compile_time_jars_in_package().contains_exactly([
        "{package}/libtest_mutable_binary_deps_foo_proto-new-mutable-hjar.jar",
        "{package}/libtest_mutable_binary_deps_baz_proto-new-mutable-hjar.jar",
    ])
    java_info.transitive_compile_time_jars().contains_at_least([
        ...
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_impl-hjar.jar",
    ])
...
def _test_mutable_proto_library_builds_compiled_jar_impl(env, target):
    env.expect.that_target(target).default_outputs().contains(
        "{package}/libtest_mutable_proto_library_builds_compiled_jar_foo_proto-new-mutable.jar",
    )
...
def _test_mutable_binary_option_deps_impl(env, target):
    java_info = env.expect.that_target(target).provider(JavaInfo)
    java_info.transitive_source_jars_in_package().contains_exactly([
        "{package}/test_mutable_binary_option_deps_foo_proto-new-mutable-src.jar",
    ])
    java_info.transitive_source_jars().contains_at_least([
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_lite-src.jar",
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_impl-src.jar",
    ...
    java_info.transitive_compile_time_jars_in_package().contains_exactly([
        "{package}/libtest_mutable_binary_option_deps_foo_proto-new-mutable-hjar.jar",
    ])
    java_info.transitive_compile_time_jars().contains_at_least([
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_lite-hjar.jar",
        "third_party/java_src/protobuf/current/java/com/google/protobuf/libprotobuf_impl-hjar.jar",
