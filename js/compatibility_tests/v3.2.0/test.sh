...
# Download protoc 3.2.0 from Maven if it is not already present.
OLD_PROTOC_URL=https://repo1.maven.org/maven2/com/google/protobuf/protoc/3.2.0/protoc-3.2.0-linux-x86_64.exe
if [ ! -f protoc ]; then
...
group1_protos="data.proto test3.proto test5.proto commonjs/test6/test6.proto test8.proto testbinary.proto testempty.proto test.proto"
...
cp -r ../../commonjs_out/google commonjs_out
