An example that demonstrates how to use the `google-protobuf` and
`google-protobuf-codegen` crates together.

The source of the latest version of this example can be read
[here](https://docs.rs/crate/google-protobuf-example/latest/source/).
