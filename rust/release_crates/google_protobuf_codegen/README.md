...
official [Protobuf crate](http://crates.io/crates/protobuf) or [Google Protobuf crate](http://crates.io/crates/google-protobuf).
...
This crate is a shallow wrapper around the `protobuf_codegen` crate that it reexports.
