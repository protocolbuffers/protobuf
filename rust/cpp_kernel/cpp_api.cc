...
#define expose_repeated_field_methods(ty, rust_ty)                           \
  google::protobuf::RepeatedField<ty>* RepeatedField_##rust_ty##_new() {               \
    return new google::protobuf::RepeatedField<ty>();                                  \
  }                                                                          \
  void RepeatedField_##rust_ty##_add(google::protobuf::RepeatedField<ty>* r, ty val) { \
    r->Add(val);                                                             \
  }                                                                          \
  size_t RepeatedField_##rust_ty##_size(google::protobuf::RepeatedField<ty>* r) {      \
    return r->size();                                                        \
  }                                                                          \
  int32_t RepeatedField_##rust_ty##_get(google::protobuf::RepeatedField<ty>* r,        \
                                        size_t index) {                      \
    return r->Get(index);                                                    \
  }                                                                          \
  void RepeatedField_##rust_ty##_set(google::protobuf::RepeatedField<ty>* r,           \
                                     size_t index, ty val) {                 \
