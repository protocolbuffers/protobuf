...
internal::MapNodeSizeInfoT GetSizeInfo(size_t key_size,
  ...
  uint8_t value_alignment = internal::RustMapHelper::Alignment(value);
  ...
  uint16_t size = offset + internal::RustMapHelper::Size(value);
  return internal::RustMapHelper::MakeSizeInfo(size, offset);
}
