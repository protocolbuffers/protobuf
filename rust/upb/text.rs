...
use super::sys::{upb_DebugString, upb_MiniTable, DebugStringOptions, RawMessage};
...
pub unsafe fn debug_string(msg: RawMessage, mt: *const upb_MiniTable) -> String {
    ...
    let len = unsafe {
        upb_DebugString(msg, mt, DebugStringOptions::NoSortMaps as i32, std::ptr::null_mut(), 0)
    };
    ...
    let written_len = unsafe {
        upb_DebugString(msg, mt, DebugStringOptions::NoSortMaps as i32, buf.as_mut_ptr(), buf.len())
    };
