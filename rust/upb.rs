...
use crate::{
    ...
    ProxiedInMapValue, ProxiedInRepeated, Proxy, Repeated, RepeatedMut, RepeatedView, View,
};
use core::fmt::Debug;
...
unsafe impl<'a, T> AssociatedMiniTable for T
where
    T: Proxy<'a>,
    T::Proxied: AssociatedMiniTable,
{
    #[inline(always)]
    fn mini_table() -> *const upb_MiniTable {
        T::Proxied::mini_table()
    }
}
