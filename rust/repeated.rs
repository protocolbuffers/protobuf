...
impl<'msg, T: ?Sized> RepeatedView<'msg, T> {
    pub fn from_inner(inner: RepeatedFieldInner<'msg>) -> Self {
        Self { inner: RepeatedField::<'msg>::from_inner(inner) }
    }
}
        ...
        $(
            ...
            impl<'a> RepeatedMut<'a, $t> {
                pub fn push(&mut self, val: $t) {
                    self.inner.inner.push(val)
                }
                pub fn set(&mut self, index: usize, val: $t) {
                    self.inner.inner.set(index, val)
                }
            }
...
pub struct RepeatedMut<'a, T: ?Sized> {
    inner: RepeatedView<'a, T>,
}

impl<'msg, T: ?Sized> RepeatedMut<'msg, T> {
    pub fn from_inner(inner: RepeatedFieldInner<'msg>) -> Self {
        Self { inner: RepeatedView::<'msg>::from_inner(inner) }
    }
}
